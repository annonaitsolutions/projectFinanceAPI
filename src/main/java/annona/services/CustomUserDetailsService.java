...
public class CustomUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username)
		...
		List<EndUser> domainUser = endUser.findByUsername(username)
				.getResultList();
		...
		return new User(domainUser.get(0).getUserName(), domainUser.get(0)
				.getPassword().toLowerCase(), enabled, accountNonExpired,
				credentialsNonExpired, accountNonLocked,
				getAuthorities(domainUser.get(0).getRole()));
	 ...
	 * UsernameNotFoundException { // TODO Auto-generated method stub return
	 * null; }
	 */
}
