...
public class SupplierForm {
	...
	public Long getSupplierBuyerId() {
		return supplierBuyerId;
	}

	public void setSupplierBuyerId(Long supplierBuyerId) {
		this.supplierBuyerId = supplierBuyerId;
	}
