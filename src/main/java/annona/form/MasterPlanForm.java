...
public class MasterPlanForm {
  ...
  private String wcStatus;
	...
	public List<MasterPlan> getMasterPlanList() {
		return masterPlanList;
	}

	public void setMasterPlanList(List<MasterPlan> masterPlanList) {
		this.masterPlanList = masterPlanList;
	}
	...
	public String getCostperUnitStr() {
		return costperUnitStr;
	}

	public void setCostperUnitStr(String costperUnitStr) {
		this.costperUnitStr = costperUnitStr;
	}
