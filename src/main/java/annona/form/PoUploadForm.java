...
public class PoUploadForm{
	...
	private List<PurchaseOrder> PoKeyList;
	...
	public List<PurchaseOrder> getPoKeyList() {
		return PoKeyList;
	}

	public void setPoKeyList(List<PurchaseOrder> poKeyList) {
		PoKeyList = poKeyList;
	}
