...
<%@taglib uri="http://www.springframework.org/tags" prefix="spring"%>
 <div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
			<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
          	   <h3><spring:message code="label.bankCustomerHeadNotificationDetails"/></h3> 
             </div>
            <form:form action="bankCustomerHeadNotificationMail" method="post" commandName="customerHeadForm">  
          	<table  align="center">
          		<tr>
			 ...
			 <div class="col-sm-12 spacer-5"></div>
			  <div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							...
							<td><a href="bankCustomerHeadNotification" class="btn btn-success"><spring:message code="label.back"/></a></td>
