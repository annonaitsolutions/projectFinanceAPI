...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
				<div class="p_content">
					<form:form action="confirmEditBankProfile" name="editProfile" autocomplete="off" commandName="endUserForm" onsubmit="return val();">
						...
						<form:hidden path="transactionId"/>
							<table align="center">
								...
								<div id="displayNameError" style="display: none; color: red;"><spring:message code="label.displayNameMandatory"/></div>
								...
								<tr>
									...
									<td class="col-sm-6"><form:input path="email" class="form-control"
										id="email"  placeholder="Enter Email" autocomplete="off" ></form:input>
								...
								<tr>
									...
									<td class="col-sm-6"><form:input path="contactNo" class="form-control"
										id="contactNo" placeholder="Enter ContactNo" autocomplete="off" ></form:input>
					<div id="contactNoError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>	
								...
								<tr>
									...
									<td class="col-sm-6"><form:input path="altContactNo" class="form-control"
										id="altContactNo" placeholder="Enter Alternate Contact" autocomplete="off"></form:input>
							 <div id="altContactNoError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
								...
								<tr>
									...
									<a href="editBankPWD?id=${model.user.id}" style="color: #f89406;"><spring:message code="label.changePassword"/></a></td>
									<td class="col-sm-6"><input type="submit"  value="<spring:message code="label.confirm"/>" class="btn btn-primary">
									<a href="bankEmp" class="btn btn-success" ><spring:message code="label.back"/></a></td>
								</tr>
