...
<form:form action="buyerRatingConfirm" method="post" commandName="newBuyerForm" onsubmit="return val();">
			...
			<div class="content col-sm-12 col-md-12 col-lg-12">
								...
								<form:hidden path="id"/>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="custLimit" placeholder="Enter Limit" id="limit"></form:input>
