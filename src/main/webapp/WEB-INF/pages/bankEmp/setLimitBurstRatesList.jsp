			...
			<table class="table data jqtable example" id="my-table">
				<thead>
					<tr>
						...
						<th><spring:message code="label.setRate"/></th>
					...
					<c:if test="${! empty limit}">
						<c:forEach items="${limit}" var="master">
							<tr>
								...
								<td><c:out value="${master.aStatus}"></c:out></td>
								<td><c:out value="${master.reqAmt}"></c:out></td>

								<td><a href="limitBurstRatesAssign?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.select"/></a></td>
									<td><a href="limitBurstSend?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.send"/></a></td>
									<td><a href="limitBurstReject?id=${master.id}"
