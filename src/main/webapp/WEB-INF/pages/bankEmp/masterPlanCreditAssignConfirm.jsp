...
<form:form action="masterPlanCreditAssignPost" name="interest"  commandName="masterPlanForm" onsubmit="return val();">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
					<table>
						...
						<tr>
							...
							<td class="col-sm-9">
								<form:input id="field1" readonly="true" path="rateOfInt" />
							</td>																
						</tr>						
						<tr>
						...
						<tr>
							...
							<tr><td>&nbsp;</td></tr>
							<tr>
								<td class="col-sm-3"><b><spring:message code="label.amountInterest"/></b></td>
								<td class="col-sm-9">
