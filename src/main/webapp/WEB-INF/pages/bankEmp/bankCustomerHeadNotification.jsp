...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
		...
		<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
			<h3><spring:message code="label.bankCustomerHeadList"/></h3>
		</div>
					...
					<c:if test="${! empty customerList}">
						<c:forEach items="${customerList}" var="customer">
							<tr>
								...
								<td><c:out value="${customer.contactNum}"></c:out></td>
								<td><c:out value="${customer.address}"></c:out></td>
								<td><c:out value="${customer.status}"></c:out></td>
								<td><c:out value="${customer.notificationStatus}"></c:out></td>
									<td>&nbsp;<a href="selectbankCustomerHeadNotification?id=${customer.id}"class="btn btn-primary"><spring:message code="label.select"/></a>
								</td>
