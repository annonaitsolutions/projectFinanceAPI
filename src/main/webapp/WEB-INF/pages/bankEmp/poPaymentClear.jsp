		...
		<div class="col-sm-12 col-md-12">	
					<div class="col-sm-12 col-md-6">
						...
						<form:hidden path="id"  />
							 	...
							 	<tr>
										<td class="col-sm-6"><b><spring:message code="label.paymentType"/></b></td>
									...
									<tr>
										<td class="col-sm-6"><b><spring:message code="label.typeOfLc/bg"/></b>
...
<div class="col-sm-12 col-md-12 col-lg-12">
				 <a	href="poPaymentClearList" class="btn btn-success"><spring:message code="label.back" /></a>
			</div>
</div>