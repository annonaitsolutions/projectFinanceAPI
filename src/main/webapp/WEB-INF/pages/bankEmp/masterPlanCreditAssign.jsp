...
<form:form action="masterPlanCreditAssignConfirm" name="interest"  commandName="masterPlanForm" onsubmit="return val();">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
					<table>
						...
						<tr>
						 ...
						 <tr>
							<td class="col-sm-3"><b><spring:message code="label.typeOfInterest"/></b></td>
							<td class="col-sm-9">
								<form:radiobutton onclick="document.getElementById('field1').disabled=false;document.getElementById('field2').disabled=true;document.getElementById('field3').disabled=true;document.getElementById('field4').disabled=true;document.getElementById('field5').disabled=true;" path="interestType" value="fixed" />Fixed
						...
						<tr><td>&nbsp;</td></tr>
						<tr>
							<td class="col-sm-3"><b><spring:message code="label.rateOfInterest"/></b></td>
							<td class="col-sm-9">
								<form:input id="field1" path="rateOfInt" value="0" disabled="true"/>									
							</td>																
						</tr>						
						<tr>
							<td class="col-sm-3"><b><spring:message code="label.noOfDays"/></b></td>
							<td class="col-sm-9">
								<form:input path="tenure"  id="txtPincode" value="365" />
							</td>																
						</tr>						
						<tr>
							...
							<tr><td>&nbsp;</td></tr>
							<tr>
								<td class="col-sm-3"><b><spring:message code="label.interestAmount"/></b></td>
								<td class="col-sm-9">
<%--									this is not rate of int, it is actually interest amount--%>
									<form:input path="rateOfInt1" id="txtPincode" value="0" />																		
								</td>																
							</tr>													
							<tr>
...
<%--							</tr>--%>
							...
							<tr>
								...
								<td class="col-sm-9">
									...
									<spring:message code="label.valAddTax"/>
										</form:option>
							...
							<tr>
								...
								<td class="col-sm-3">
									<form:input path="taxPercentage" id="txtPincode" value="0"/>	
								</td>
								<td class="col-sm-3"><input type="button" value="Generate" style="margin-left: 64px;" onClick="taxamnt()"></td>
								<td class="col-sm-3"><form:input path="taxAmt" value="0" size="20" readonly="readonly"/></td>																
							</tr>														
							...
							<tr>
								<td class="col-sm-3"><b><spring:message code="label.taxPerc"/></b></td>
								<td class="col-sm-3">
									<form:input path="taxPercentage1" id="txtPincode" value="0" />	
									
								</td>
								<td class="col-sm-3"><input type="button" value="Generate" style="margin-left: 64px;" onClick="taxamnt1()"></td>
								<td class="col-sm-3"><form:input path="taxAmt1" value="0" size="20" readonly="readonly"/></td>																
							</tr>														
							...
							<tr>
								<td class="col-sm-3"><b><spring:message code="label.taxPerc"/></b></td>
								<td class="col-sm-3"><form:input path="taxPercentage2" id="txtPincode" value="0"/></td>
								<td class="col-sm-3"><input type="button" value="Generate" style="margin-left: 64px;" onClick="taxamnt2()"></td>
								<td class="col-sm-3"><form:input path="taxAmt2" value="0" size="20" readonly="readonly"/></td>																
							</tr>														
							...
							<tr>
								...
								<td class="col-sm-9">
									<form:input path="funalAmt" id="txtPincode" value="0"/>																		
								</td>																
							</tr>
						</table>	
