...
<form:form action="buyerRatingPost" method="post" name="rating" commandName="newBuyerForm" onsubmit="return ValidateForm();">
			...
			<div class="content col-sm-12 col-md-12 col-lg-12">
								<table align="center">
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="buyerName" readonly="true" placeholder="Enter Name"></form:input>
								...
								<form:hidden path="id"/>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="custLimit" readonly="true" placeholder="Enter Limit" id="Limit"></form:input>
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							...
							<td><a href="buyerRatingList" class="btn btn-success"><spring:message code="label.back"/></a></td>
