...
<%@taglib uri="http://www.springframework.org/tags" prefix="spring"%>
 ...
 <div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
 	...
 	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
 		<h3 align="center"><spring:message code="label.masterPlanPendingList"/></h3>
 	</div>
...
<%--						<th><spring:message code="label.riskAssignment"/></th>--%>
						...
						<th><spring:message code="label.ConBankDetails"/></th>
						<th><spring:message code="label.workingCapitalAssignment"/></th>
						<th><spring:message code="label.sendForApproval"/></th>
					</tr>
				</thead>
				<tbody>
					<c:if test="${! empty masterList}">
						<c:forEach items="${masterList}" var="master">
							<tr>
								...
								<td><a href="bankMasterPlanFullDetails?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
<%--									<td><a href="riskAssignment"--%>
<%--									class="btn btn-primary"><spring:message code="label.view"/></a></td>--%>
									<td><a href="masterPlanCreditAssign?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.assign"/></a></td>
									<td><a href="masterPlanConsBank?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.add"/></a></td>
									<td><a href="masterPlanWcAssign?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.assign"/></a></td>
									<td><a href="bankMasterPlanSend?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.send"/></a></td>
							</tr>
						</c:forEach>
					</c:if>
