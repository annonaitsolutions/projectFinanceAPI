...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
		...
		<div class="col-sm-12 col-md-6 col-lg-6">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
						<h3 style="font-size:19px; font-weight:400; color:#2E9AFE;"><spring:message code="label.ConBankDetails"/></h3>
				...
				<tbody>
					<c:if test="${! empty bankList}">
						<c:forEach items="${bankList}" var="bankList">
							<tr>
								<td><c:out value="${bankList.status}"></c:out></td>
								<td><c:out value="${bankList.bankName}"></c:out></td>
								<td><c:out value="${bankList.bankBranch}"></c:out></td>
								<td><c:out value="${bankList.location}"></c:out></td>
								<td><c:out value="${bankList.bankLimit}"></c:out></td>
							</tr>
						</c:forEach>
					</c:if>
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
				...
				<div class="col-sm-12 col-md-12 col-lg-12">	
						<h3 style="font-size:19px; font-weight:400; color:#2E9AFE;"><spring:message code="label.sellerBuyingCostDetails"/></h3>
					</div>
				...
				<tbody>
					<c:if test="${! empty sellerList}">
						<c:forEach items="${sellerList}" var="sellerList">
							<tr>
								<td><c:out value="${sellerList.buyerName}"></c:out></td>
								<td><c:out value="${sellerList.finalPro}"></c:out></td>
								<td><c:out value="${sellerList.quantity}"></c:out></td>
								<td><c:out value="${sellerList.amt}"></c:out></td>
							</tr>
						</c:forEach>
					</c:if>
...
<div class="col-sm-12 col-md-12 col-lg-12">
					<%-- <table align="center">
						<tr>
							<td><a href="masterPlanFullList" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table> --%>
		        </div>
