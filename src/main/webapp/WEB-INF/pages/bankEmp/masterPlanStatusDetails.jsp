...
<br>
			<br>
			<h3 align="center"><spring:message code="label.approvedMasterPlanList"/></h3>
			...
			<table class="table data jqtable example" id="my-table">
				<thead>
					<tr>
						...
						<th><spring:message code="label.statusReport"/></th>
					...
					<c:if test="${! empty masterList}">
						<c:forEach items="${masterList}" var="master">
							<tr>
								...
								<td><a href="bankEmpStatusTable?id=${master.id}"
