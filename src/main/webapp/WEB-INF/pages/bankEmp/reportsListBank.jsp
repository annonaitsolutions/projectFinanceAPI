...
<form:form  action="reportsPOBankPost" name="myForm" commandName="purchaseOrderForm" onsubmit="return val();">
						...
						<table align="center">
							...
							<tr>
								<td id="e1" class="col-sm-6">
								 <div class="col-sm-12 col-md-12 header_customer">
              					        	<h3 align="center"> <label><b><spring:message code="label.from"/></b></label></h3>		
              					        	</div>			 
								...
								<td id="e1" class="col-sm-6">
									...
									<h3 align="center"> <label><b><spring:message code="label.to"/></b></label> </h3>     
				...
				<table align="center">
					<tr>
						<td class="col-sm-8"><input type="submit" 
						    value="<spring:message code="label.view"/>" class="btn btn-primary"></td>
						<td><a href="bankEmp" class="btn btn-success">
