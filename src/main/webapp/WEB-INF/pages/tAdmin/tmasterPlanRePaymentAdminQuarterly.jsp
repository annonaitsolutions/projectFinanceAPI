...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
	...
	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
			<h3><spring:message code="label.quaterlyPayment"/></h3>
	</div>
				<div class="col-sm-12 col-md-12 col-lg-12">
			...
			<table class="table data jqtable example" id="my-table">
				<thead>
					<tr>
						...
						<th><spring:message code="label.payDate"/></th>
						<th><spring:message code="label.installmentThree"/></th>
						<th><spring:message code="label.payDate"/></th>
						<th><spring:message code="label.installmentFour"/></th>
						<th><spring:message code="label.payDate"/></th>
					...
					<c:if test="${! empty full}">
						<c:forEach items="${full}" var="master">
							<tr>
								...
								<td><c:out value="${master.amount2}"></c:out></td>
								<td><c:out value="${master.payDat2}"></c:out></td>
								<td><c:out value="${master.amount3}"></c:out></td>
								<td><c:out value="${master.payDate3}"></c:out></td>
...
<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							<td><a href="tmasterPlanRePaymentAdminList" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
</div>
</div>
