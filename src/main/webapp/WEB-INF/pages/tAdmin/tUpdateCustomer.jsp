...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
			...
			<form:form action="tUpdateCustomerHeadConfirm" commandName="customerHeadForm" onsubmit="return val();">
							...
							<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<a href="tCreateCustomerHead" class="btn btn-success"><spring:message code="label.back"/></a>
								</p>
							</div>
