...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
		<h3 align="center"><spring:message code="label.tradingCustomerAdminHelp"/></h3>
	</div>	
	<div class="col-sm-12 col-md-12 col-lg-12">
		<div id="flip"><spring:message code="label.tradingCustomerAdminHelp1"/></div>
		<div id="panel"><spring:message code="label.tradingCustomerAdminHelp2"/></div>
