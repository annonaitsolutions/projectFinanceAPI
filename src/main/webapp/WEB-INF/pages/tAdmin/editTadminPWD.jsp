...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
				<div class="p_content">
					<form:form action="updateEditTadminPWD" name="editProfile" autocomplete="off" onsubmit="return validateForm()" commandName="endUserForm">
				...
				<div id="alertPWD" style="display: none; color: red;"><spring:message code="label.passVal"/></div>
							...
							<table align="center">
								...
								<tr>
									...
									<td class="col-sm-6"><label for=""><spring:message code="label.newPass"/>:</label></td>
