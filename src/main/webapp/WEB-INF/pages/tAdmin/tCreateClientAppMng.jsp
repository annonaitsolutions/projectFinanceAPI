...
<form:form action="tClientAppMngConfirm" method="post" commandName="clientAppMngForm" onsubmit="return val();">
	 <div  class="successMsg"><b><font color="green">${success}</font></b></div>
				<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
					<h3 align="center"><spring:message code="label.addApprovalManager"/></h3>
				</div>
...
<td class="col-sm-6"><form:select path="companyId"  id="companyId" style="width:205px;">
<form:option value=""><spring:message code="label.selectValue" /></form:option>
<c:forEach var="item" items="${companyList}"><form:option value="${item.id}">${item.companyName}</form:option></c:forEach>
</form:select></td>
</td>
</tr>
									<tr>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="altContactNum" placeholder="Enter Alternative Contact Number" id="altContactNum"></form:input>
										   <span id="contactNum2Error" class="error" style="display:none"><font color="red"><spring:message code="label.validation"/>*</font></span></td>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="altEmail" placeholder="Enter Alternative Email " id="altEmail"></form:input>
										 <span id="altemailError" class="error" style="display:none"><font color="red"><spring:message code="label.validation"/>*</font></span></td>
									...
									<tr>
										...
										<td id="e1" class="col-sm-6"><form:input path="accExpiryDate" class="form-control" placeholder="Select Date" style="width: 139px;" readonly="true" id="datepicker"/><i class="fa fa-calendar"></i>
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<a href="custTradeAdminPage" class="btn btn-success"   onclick="javascript:window.location='#';"><spring:message code="label.back"/></a>
								</p>
		</div>
		</div>
		</form:form>
	  ...
	  <span class="counter pull-right"></span>
			...
			<table class="table data jqtable example" id="my-table">
				...
				<tbody>
					<c:if test="${! empty appMngList}">
						<c:forEach items="${appMngList}" var="customer">
							<tr>
								...
								<td><a href="tSelectClientAppMng?id=${customer.id}"
