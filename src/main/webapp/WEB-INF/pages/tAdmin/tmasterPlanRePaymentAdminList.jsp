					...
					<c:if test="${! empty repayList}">
						<c:forEach items="${repayList}" var="master">
							<tr>
								...
								<td><a href="tmasterPlanRePaymentAdminFullList?id=${master.id}"
									class="btn btn-primary">View</a></td>
									<td><a href="tmasterPlanRePaymentAdminQuarterly?id=${master.id}"
									class="btn btn-primary">View</a></td>
									<td><a href="tmasterPlanRePaymentAdminHalfYearly?id=${master.id}"
									class="btn btn-primary">View</a></td>
