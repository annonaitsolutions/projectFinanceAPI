...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
				...
				<h3><spring:message code="label.proDetails"/></h3>
				</div>
				<form:form name="bankDetails" action="updateTadminDetails" commandName="endUserForm"
				...
				<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							...
							<td><a href="custTradeAdminPage" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
