...
<form:form action="vPoForRenewelConfirm" commandName="purchaseOrderForm" onsubmit="return val();">
					...
					<table align="center">
						<tr>
							...
							<td><a href="vPoListForRenewel" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
