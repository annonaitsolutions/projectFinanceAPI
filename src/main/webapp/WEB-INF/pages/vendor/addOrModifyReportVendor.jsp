...
<div class="col-sm-6 col-md-9 col-lg-9 body_fixed">
				...
				<form:form action="addOrModifyReportVendorConfirm" method="post" commandName="disputeReportsForm" enctype="multipart/form-data"  name="interest" onsubmit="return val();">
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
				...
				<table align="center">
					...
					<tr>	
						...
						<td class="col-sm-6">
							<form:input path="suppDefectQty"  class="form-control"  id="defectQty"/>
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							...
							<td><a href="addOrModifyReportVendorList" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
