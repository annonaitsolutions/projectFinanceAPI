...
<form:form name="banksupplierUpdate" action="buyerTradePageShowConfirmApproval" commandName="buyerTradeForm" onsubmit="return val();">

			<div class="content">
			
			<form:hidden path="transactionId"/>
			<form:hidden path="cStatus"/>
								<table align="center">
								<tr>
					...
					<td id="statusError" class="error" style="display:none;"><font color="red"><spring:message code="label.selectValue"/></font></td>
						<td id="statusError" class="error" style="display:none"><spring:message code="label.selectValue"/></td>
									...
									<tr>
										...
										<td  class="col-sm-6" id="commentError" class="error" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></td>
										    <td  class="col-sm-6" id="commentError" class="error" style="display:none"><spring:message code="label.validation"/></td>
...
<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							...
							<td><a href="buyerCustomerTradeApprovalList" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
