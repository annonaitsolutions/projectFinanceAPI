...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
 ...
 <div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
			 ...
			 <div class="col-sm-12 col-md-12 col-lg-12 header_customer">
				...
				<div class="p_content">
					<form:form action="updateEditAppMngTradePWD" name="editProfile" autocomplete="off" onsubmit="return validateForm()" commandName="endUserForm">
							...
							<table align="center">
								...
								<tr>
									...
									<td class="col-sm-6"><form:password path="newPassword" class="form-control"
										...
										<div id="newPasswordError" style="display: none; color: red;"><spring:message code="label.validation"/></div>
				<div id="newPasswordError" style="display: none; color: red;"><spring:message code="label.validation"/></div>
					<span id="newPasswordError" style="display: none; color: red;">New Password is 6 Character Mandatory</span>
									</td>
								</tr>
								<tr>
									...
									<td class="col-sm-6"><form:password path="confirmNewPassword" class="form-control"
										...
										<div id="confirmNewPasswordError" style="display: none; color: red;"><spring:message code="label.validation"/></div>
				<div id="confirmNewPasswordError" style="display: none; color: red;"><spring:message code="label.validation"/></div>
					<span id="confirmNewPasswordError" style="display: none; color: red;">Confirm New Password is 6 Character Mandatory</span>
									</td>
								</tr>
