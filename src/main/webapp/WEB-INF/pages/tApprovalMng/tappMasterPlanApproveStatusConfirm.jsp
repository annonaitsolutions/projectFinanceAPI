...
<form:form action="tappMasterPlanApproveStatusPost" name="bankMasterPlanApproveStatusPost" method="post" commandName="tMasterPlanForm" onsubmit="return validateForm();">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<form:hidden path="customerEmail" value="" />
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="managerStatus"  readonly="true" placeholder="Enter status" id="contactno"></form:input>
