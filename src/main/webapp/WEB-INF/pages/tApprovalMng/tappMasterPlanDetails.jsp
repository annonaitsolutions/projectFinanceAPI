					...
					<c:if test="${! empty masterList}">
						<c:forEach items="${masterList}" var="master">
							<tr>
								...
								<td><a href="tappMasterPlanFullDetails?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
									<td><a href="tappRiskAssignment"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
									<td><a href="tappMasterPlanCreditAssign?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
									<td><a href="tappMasterPlanApproveStatus?id=${master.id}"
