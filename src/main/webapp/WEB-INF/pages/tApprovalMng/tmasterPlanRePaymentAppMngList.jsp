					...
					<c:if test="${! empty repayList}">
						<c:forEach items="${repayList}" var="master">
							<tr>
								...
								<td><a href="tmasterPlanRePaymentAppFullList?id=${master.id}"
									class="btn btn-primary">View</a></td>
									<td><a href="tmasterPlanRePaymentAppQuarterly?id=${master.id}"
									class="btn btn-primary">View</a></td>
									<td><a href="tmasterPlanRePaymentAppHalfYearly?id=${master.id}"
									class="btn btn-primary">View</a></td>
									<td><a href="tmasterPlanRePaymentAppMngAppr?id=${master.id}"
