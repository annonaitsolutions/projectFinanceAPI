...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
				...
				<form:form name="customerDetails" action="updateTradeAppMngDetails" commandName="endUserForm"
						...
						<table align="center">
							<tr>
								<td class="col-sm-8"><input type="submit"  value="<spring:message code="label.update"/>" class="btn btn-primary"></td>
									<td><a href="tApprMng" class="btn btn-success" ><spring:message code="label.back"/></a></td>
							</tr>
						</table>
					</div>
