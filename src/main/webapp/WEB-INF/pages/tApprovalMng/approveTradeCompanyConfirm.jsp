...
<form:form action="approveTradeCompanySave" name="approveCompanySave" commandName="companyForm" onsubmit="return validateForm();">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
					...
					<table align="center">
						<tr>
							...
							<td><a href="approveTradeCompany" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
									</div>
