...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
  <div class="col-sm-12 col-md-12 col-lg-12 header_customer">
			 	<h3 align="center"><spring:message code="label.confirmScreen"/></h3>
					...
					<form:form name="bankbuyerUpdate" action="updateTradebuyerPageShowConfrim" method="post"
					...
					<form:input path="id" id="id" 	value="${model.buyerTradeForm.id}" readonly="true"/>
					</td>
				</tr>
					 <tr>
							...
							<td class="col-sm-6"><form:input path="name" id="name"
									...
									value="${model.buyerTradeForm.name}" readonly="true" />
						</tr> 
					...
					<form:hidden path="bName" value="${model.buyerTradeForm.bName}"/>
                   	...
                   	<tr>
							...
							<td class="col-sm-6"><form:input path="status"
									...
									value="${model.buyerTradeForm.status}" readonly="true" /></td>
	                     ...
	                     <tr>
							...
							<td class="col-sm-6"><form:input path="comment"
									...
									value="${model.buyerTradeForm.comment}" readonly="true" /></td>
						</tr>
