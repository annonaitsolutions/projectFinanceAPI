...
<nav class="navbar  navbar2">
	<div class="container-fluid">
	    <div class="navbar-header">
	      <a class="navbar-brand" href="adminPage"><i class="glyphicon glyphicon-home"></i></a>
	    ...
	    <div id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
					<li class="log_out"><a href="adminHelp"><i class="glyphicon glyphicon-modal-window"></i>&nbsp;<strong><spring:message code="label.menuHelp"/></strong></a></li>
