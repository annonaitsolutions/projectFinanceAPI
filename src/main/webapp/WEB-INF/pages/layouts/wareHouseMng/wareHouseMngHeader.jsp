...
<nav class="navbar navbar1">
	<div class="container-fluid">
		<div class="navbar-header col-sm-2 col-xs-12 logo_1">
			<a href="wareHouseMngPage" class="main_logo_link"><img src="<%=request.getContextPath()%>/resources/images/logopng44.png" alt="ANNONA IT SOLUTIONS" class="a_logo img-responsive" title="ANNONA IT SOLUTIONS PVT.LTD."></a>
...
<nav class="navbar  navbar2">
	<div class="container-fluid">
	    <div class="navbar-header">
	      <a class="navbar-brand" href="wareHouseMngPage"><i class="glyphicon glyphicon-home"></i></a>
	              &nbsp;&nbsp;<a href="#" style="color: #005C79;">DHANAPURTHI&nbsp;<sup>TM</sup></a>
	    </div>
		<div class="pull-left">

				<div class="prof_img"><a href="editWareHouseMngProfile?id=${requestCurrentUser.id}"><span><img src="${requestCurrentUser.imageName}" class="profile_img"></span><span class="customer_name"><spring:message code="label.welcome" /> ${requestCurrentUser.displayName}</span></a></div>

		</div>
	    <div id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
			<li class="log_out"><a href="whMngHelp"><i class="glyphicon glyphicon-modal-window"></i>&nbsp;<strong><spring:message code="label.menuHelp"/></strong></a></li>
