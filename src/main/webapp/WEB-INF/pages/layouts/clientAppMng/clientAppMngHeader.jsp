...
<%--	      <a class="navbar-brand" href="clientApprMngCommon"><i class="glyphicon glyphicon-home"></i></a>--%>
			      <a class="navbar-brand" href="clientApprMng"><i class="glyphicon glyphicon-home"></i></a>
	            &nbsp;&nbsp;<a href="#" style="color: #005C79;">DHANAPURTHI&nbsp;<sup>TM</sup></a>
	    </div>
		<div class="pull-left">

				<div class="prof_img"><a href="editCustAppProfile?id=${requestCurrentUser.id}"><span><img src="${requestCurrentUser.imageName}" class="profile_img"></span><span class="customer_name"><spring:message code="label.welcome" /> ${requestCurrentUser.displayName}</span></a></div>

		</div>
	    <div id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
			<li class="log_out"><a href="custAppHelp"><i class="glyphicon glyphicon-modal-window"></i>&nbsp;<strong><spring:message code="label.menuHelp"/></strong></a></li>
