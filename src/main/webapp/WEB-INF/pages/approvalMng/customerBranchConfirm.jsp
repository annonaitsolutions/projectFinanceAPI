...
<form:form action="approveCustomerBranchSave" name="approveCustomerBranchSave" commandName="customerBranchForm" onsubmit="return validateForm();">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<form:hidden path="roleType"  />
									...
									<tr>
											...
											<td class="col-sm-6"><form:input path="status" readonly="true"  id="companyName"></form:input>
