...
<form:form action="appMasterPlanApproveStatusPost" name="bankMasterPlanApproveStatusPost" method="post" commandName="masterPlanForm" onsubmit="return validateForm();">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<form:hidden path="customerEmail" value="" />
									...
									<tr>
											...
											<td class="col-sm-6"><form:input path="masterKey" readonly="true" ></form:input>
											</td>															
									</tr>
									
									<tr>
										<td class="col-sm-6"><b><spring:message code="label.status"/></b><span style="color:red">*</span></td>
										<td class="col-sm-6"><form:input path="managerStatus"  readonly="true"  id="contactno"></form:input>
										
									</tr>
									<tr>
										<td class="col-sm-6"><b><spring:message code="label.comment"/></b></td>
										<td class="col-sm-6"><form:input path="managerComment"  readonly="true" placeholder="Enter comment" id="txtAlternateContactNumber"></form:input>
										</td>
									</tr>		
						</table>
			</div>
