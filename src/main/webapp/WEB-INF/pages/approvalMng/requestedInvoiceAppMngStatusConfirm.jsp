...
<form:form  action="requestedInvoiceAppMngStatusPost" name="myForm" commandName="invoiceForm" onsubmit="return val();">
					...
					<div class="col-sm-12 col-md-12">
								<table align="center">
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="transComment" placeholder="Enter name" readonly="true"></form:input>
