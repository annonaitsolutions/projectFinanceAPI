...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
		<div class="col-sm-12 col-md-12 col-lg-12">
				<h3><spring:message code="label.rePaymentRequest"/></h3>
		</div>
		<div class="col-sm-12 col-md-12 col-lg-12">
					...
					<c:if test="${! empty repayList}">
						<c:forEach items="${repayList}" var="master">
							<tr>
								...
								<td><a href="masterPlanRePaymentAppFullList?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
									<td><a href="masterPlanRePaymentAppQuarterly?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
									<td><a href="masterPlanRePaymentAppHalfYearly?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
									<td><a href="masterPlanRePaymentAppMngAppr?id=${master.id}"
