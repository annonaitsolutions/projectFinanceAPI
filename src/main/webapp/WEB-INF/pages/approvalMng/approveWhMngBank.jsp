...
<form:form action="approveWhMngBankConfirm" commandName="wareHouseMngForm" onsubmit="return val();">
<div class="col-sm-12 col-md-12 header_customer"><h3 align="center"><spring:message code="label.warreHouseMngApp"/></h3></div>
						<div class="col-sm-12 col-md-12">
								...
								<table align="center">
									...
									<tr>
										<td class="col-sm-6"><b><spring:message code="label.managerName"/></b></td>
										<td class="col-sm-6"><form:input path="mngName"  readonly="true"></form:input>
									...
									<tr>
										...
										<tr>
												...
												<td class="col-sm-6"><form:select path="bStatus" id="status" style="width:205px;">
										...
										<tr>
											...
											<td class="col-sm-6"><form:textarea path="bComment" id="comment" placeholder="Enter Comment" style="height:120px;"></form:textarea></td>
					...
					<table align="center">
						<tr>
							...
							<td><a href="whMngBankApprovalList" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>		
