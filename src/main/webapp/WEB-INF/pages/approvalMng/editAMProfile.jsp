...
<div class="col-sm-9 col-sm-9 col-lg-9 body_fixed">
	...
	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
				<div class="p_content">
					<form:form action="confirmEditAMProfile" name="editProfile" autocomplete="off" commandName="endUserForm" onsubmit="return val();">
						...
						<form:hidden path="transactionId"/>
							<table align="center">
								...
								<tr>
									...
									<td class="col-sm-6"><form:input path="email" placeholder="Enter Email" class="form-control"
						...
						<div id="EmailError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>	
								...
								<tr>
									...
									<a href="editAMPWD?id=${model.user.id}" style="color: #f89406;"><spring:message code="label.changePassword"/></a></td>
									<td class="col-sm-6"><input type="submit"  value="<spring:message code="label.confirm"/>" class="btn btn-primary">
									<a href="apprMng" class="btn btn-success" ><spring:message code="label.back"/></a></td>
								</tr>
							</table>
						</div>
				</form:form>
