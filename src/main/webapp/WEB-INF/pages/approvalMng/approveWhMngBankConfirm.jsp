...
<form:form action="approveWhMngBankSave" name="approveCustomerHeadSave" commandName="wareHouseMngForm" onsubmit="return validateForm();">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<form:hidden path="id"/>
									...
									<tr>
										...
										<td class="col-sm-7"><form:input path="mngName"  readonly="true"></form:input>
									...
									<tr>
										...
										<td class="col-sm-7"><form:input path="bStatus" readonly="true" id="status" placeholder="Enter Comment"></form:input></td>															
									</tr>
									<tr>
										<td class="col-sm-5"><b><spring:message code="label.comment"/></b><span style="color:red">*</span></td>
										<td class="col-sm-7"><form:textarea path="bComment" id="comment" placeholder="Enter Comment" style="height:120px;" readonly="true"></form:textarea>
