...
<form:form action="approveCompanyConfirm" commandName="companyForm" onsubmit="return val();">
<div class="col-sm-12 col-md-12 header_customer"><h3 align="center"><spring:message code="label.companyApproval"/></h3></div>
					...
					<table align="center">
						<tr>
							...
							<td><a href="companyList" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>		
