...
<section>	
<form:form action="invoiceForApprovalConfirm" commandName="invoiceForm" onsubmit="return val();">
<div class="heading"><spring:message code="label.approval"/></div>
			<div class="content">
								...
								<form:hidden path="customerHeadEmail"  />
									...
									<tr>
										<td class="col-sm-2" style="width:23.666667%;"><b><spring:message code="label.buyerName"/></b></td>
										<td class="col-sm-8"><form:input path="buyerName" readonly="true" placeholder="Enter Company Name" id="companyName" style="width:85%"></form:input>
