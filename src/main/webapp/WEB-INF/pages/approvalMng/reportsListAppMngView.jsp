...
<div class="col-sm-9 col-md-9 body_fixed">
		...
		<div class="pull-right download-color">			 
			...
			<table class="table data jqtable example" id="my-table">
				...
				<tbody>
					<c:if test="${! empty purchaseOrderForm.purchaseList}">
						<c:forEach items="${purchaseOrderForm.purchaseList}" var="master">
							<tr>
...
<div class="col-sm-12 col-md-12 col-lg-12">
	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							<td><a href="reportsListAppMng" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
