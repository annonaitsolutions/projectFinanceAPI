...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
					<form:form action="confirmEditTCustAppProfile" name="editProfile" autocomplete="off" commandName="endUserForm" onsubmit="return val();">
						...
						<form:hidden path="transactionId"/>
							<table align="center">
								...
								<tr>
									...
									<td class="col-sm-6"><form:input path="displayName" class="form-control" id="displayName" placeholder="Enter Dispaly Name"
						...
						<div id="contactNoError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
							...
							<div id="altContactNoError" class="error col-sm-12" style="display:none;"><font color="red">Please Enter a Integer Value</font></div>
							<div id="altContactNoError" class="error" style="display:none">Please Enter a Integer Value</div>
									</td>
								</tr>
								...
								<tr>
									<td class="col-sm-6">
									<a href="editTCustAppPWD?id=${model.user.id}" style="color: tomato;">Change Password</a></td>
									<td class="col-sm-6"><input type="submit"  value="<spring:message code="label.confirm"/>" class="btn btn-primary">
									<a href="tClientApprMng" class="btn btn-success" ><spring:message code="label.back"/></a></td>
								</tr>
							</table>
						</div>
				</form:form>
