...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
	...
	<div>
			<form:form name="banksupplierUpdate" action="supplierPageShowApprovalConfirm" commandName="supplierTradeForm" onsubmit="return val();">
				...
				<tr>
					...
					<td class="col-sm-6"><form:errors path="id" cssStyle="color:red"></form:errors></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="col-sm-6"><form:errors path="supplierName" cssStyle="color:red"></form:errors></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="col-sm-6">
						<form:errors path="contactNum" Style="color:red"></form:errors>
					</td>
				</tr>
				...
				<tr>
					...
					<tr>
						...
						<td class="col-sm-6"><form:input path="comment" id="comment"
								placeholder="Enter Comment"></form:input>
