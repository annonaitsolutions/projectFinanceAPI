...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
		...
		<table  align="center">
			<tr>
				...
				<td class="col-sm-6"><input type="text" name="euro" placeholder="Enter Amount in Euro" onChange="euroConverter()" /></td>
			</tr>
			<tr>
				<td class="col-sm-6"><b><spring:message code="label.dollar"/>:</b> </td>
				<td class="col-sm-6"><input type="text" name="dollar" placeholder="Enter Amount in Dollar" onChange="dollarConverter()" /></td>
			</tr>
			<tr>
				<td class="col-sm-6"><b><spring:message code="label.pound"/> (&pound;):</b></td>
				<td class="col-sm-6"><input type="text" name="pound" placeholder="Enter Amount in Pound" onChange="poundConverter()" /></td>
			</tr>
			<tr>
				<td class="col-sm-6"><b><spring:message code="label.yen"/> (&yen;):</b> </td>
				<td class="col-sm-6"><input type="text" name="yen" placeholder="Enter Amount in Yen" onChange="yenConverter()" /></td>
			</tr>
			<tr>
				<td class="col-sm-6"><b><spring:message code="label.indRup"/> (&#x20B9;) :</b> </td>
				<td class="col-sm-6"><input type="text" name="rupee"  placeholder="Enter Amount in Rupee" onChange="rupeeConverter()" /></td>
			</tr>
			<tr>
				<td class="col-sm-6"><b><spring:message code="label.saudi"/> : </b> </td>
				<td class="col-sm-6"><input type="text" name="riyal" placeholder="Enter Amount in Saudi Riyal" onChange="riyalConverter()" /></td>
			</tr>
			<tr>
				<td class="col-sm-6"><b><spring:message code="label.yuhan"/> (&yen;) :</b> </td>
				<td class="col-sm-6"><input type="text" name="yuhan" placeholder="Enter Amount in Yuhan" onChange="chineseConverter()" /></td>
			</tr>
	...
	<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							<td class="col-sm-8"><input type="submit" value="<spring:message code="label.curConvert"/>" class="btn btn-primary"></td>
							<td><a href="tClientApprMng" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
</div>