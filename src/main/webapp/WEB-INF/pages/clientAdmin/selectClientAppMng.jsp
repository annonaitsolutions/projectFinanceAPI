...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
			...
			<form:form action="updateClientAppMngConfirm" commandName="clientAppMngForm" onsubmit="return val();">
							...
							<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<a href="createClientAppMng" class="btn btn-success"   onclick="javascript:window.location='#';"/><spring:message code="label.back"/></a>
								</p>
							</div>
