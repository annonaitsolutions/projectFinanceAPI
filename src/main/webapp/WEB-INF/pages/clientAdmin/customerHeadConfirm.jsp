...
<form:form action="customerHeadSave" name="customerHeadSave" method="post" commandName="customerHeadForm" onsubmit="return validateForm();">
			...
			<div class="col-sm-6 col-md-6 col-lg-6">
								...
								<caption><spring:message code="label.personalDetails"/></caption>
									...
									<tr>
										...
										<td class="col-sm-7"><form:input path="manager" readonly="true" placeholder="Enter manager name" id="manager"></form:input>
																									
									</tr>
									<tr>
										<td class="col-sm-5"><b><spring:message code="label.managerEmail"/></b><span style="color:red">*</span></td>
										<td class="col-sm-7"><form:input path="managerEmail" readonly="true" placeholder="Enter manager email" id="managerEmail"></form:input>
																									
									</tr>
									<tr>

									<fmt:formatDate value="${customerHeadForm.accExpiryDate}" var="formatDate" pattern="dd/MM/yyyy"/>
								...
								<a href="custAdminPage" class="btn btn-success"><spring:message code="label.back"/></a>
								</p>
		</div>
