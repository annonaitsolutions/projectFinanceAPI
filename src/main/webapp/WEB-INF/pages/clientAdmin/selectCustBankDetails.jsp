<%@include file="taglib_includes.jsp"%>
 <div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
			...
			<form:form action="updateCustBDetails" method="post" commandName="customerBankDetailsForm" onsubmit="return val();">
				...
				<table align="center">
					<tr>
						...
						<td><a href="custBankDetails" class="btn btn-success">
