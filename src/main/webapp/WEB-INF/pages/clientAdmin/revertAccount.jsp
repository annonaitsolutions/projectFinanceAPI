...
<div class="col-sm-9 col-md-9 body_fixed">
	<form:form action="updateRevertAccount" commandName="swapAccountForm">
		<div class="col-sm-12 col-md-12 header_customer">
			<h3 align="center"><spring:message code="label.revertAccount"/></h3>
		</div>
		...
		<div class="col-sm-6 col-md-6">
			...
			<table align="left">
				...
				<tr>
					<td class="col-sm-5"><b><spring:message code="label.userEmail"/></b></td>
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			...
			<form:hidden path="endUserId" value="${swapAccountForm.endUserId}"/>
				<input type="submit" class="btn btn-primary" value="<spring:message code="label.revert"/>"> 
