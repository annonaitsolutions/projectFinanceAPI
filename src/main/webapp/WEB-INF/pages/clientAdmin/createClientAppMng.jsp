...
<form:form action="clientAppMngConfirm" method="post" commandName="clientAppMngForm" onsubmit="return val();">
	 <div  class="successMsg"><b><font color="green">${success}</font></b></div>
				<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
					<h3 align="center"><spring:message code="label.addNewCustomer"/></h3>
				</div>
...
<c:forEach var="item" items="${companyList}"><form:option value="${item.id}">${item.companyName}</form:option></c:forEach>
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<a href="custAdminPage" class="btn btn-success"   onclick="javascript:window.location='#';"><spring:message code="label.back"/></a>
								</p>
		</div>
		</div>
		</form:form>
					...
					<c:if test="${! empty appMngList}">
						<c:forEach items="${appMngList}" var="customer">
							<tr>
								...
								<td><a href="selectClientAppMng?id=${customer.id}"
