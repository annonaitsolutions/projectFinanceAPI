			...
			<table class="table data jqtable example" id="my-table">
				...
				<tbody>
					<c:if test="${! empty disList}">
						<c:forEach items="${disList}" var="master">
							<tr>
								...
								<td><a href="disputeMng?id=${master.id}" class="btn btn-primary" onclick="return confirm();"><spring:message code="label.select"/></a></td>
							</tr>
						</c:forEach>
					</c:if>
