...
<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
					<form:form action="confirmEditWareHouseMngProfile" name="editProfile" autocomplete="off" commandName="endUserForm" onsubmit="return val();">
					<div class="Pro_img1" style="text-align:center;">
						...
						<div id="contactNoError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>	
							...
							<div id="altContactNoError" class="error" style="display:none"><spring:message code="label.validation"/></div>
								...
								<tr>
									<td class="col-sm-6">
									<a href="editWareHouseMngPWD?id=${model.user.id}" style="color: #f89406;"><spring:message code="label.changePassword"/></a></td>
							...
							<div class="modal-body login-modal">
								...
								<div id='social-icons-conatainer'>
									<div class='modal-body-left'>
										<form:form action="updateImageForWareHouseMngProfile" commandName="endUserForm" enctype="multipart/form-data">
