...
<form:form action="cPoForApprovalPost" commandName="purchaseOrderForm" onsubmit="return val();">
			<div class="col-sm-12 col-md-12 col-lg-12 header_customer"><h3 align="center"><spring:message code="label.confirmationScreen"/></h3></div>
