...
<form:form action="capproveCustomerBranchConfirm" commandName="customerBranchForm" onsubmit="return val();">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<form:hidden path="id"  />
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="customerPrefix" readonly="true"  id="customerPrefix"></form:input></td>
											
									</tr>
									
									<tr>
										<td class="col-sm-6"><b><spring:message code="label.customerHeadName"/>:</b></td>
										<td class="col-sm-6"><form:input path="customerHeadName" readonly="true"  id="companyName"></form:input></td>
									...
									<tr>
											...
											<td class="col-sm-6"><form:select path="aStatus" id="status">
