...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
			<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
				...
				<form:form name="bankDetails" action="updateCustAppDetails" commandName="endUserForm"
					...
					<table align="center">
						<tr>
							...
							<td><a href="clientApprMng" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
