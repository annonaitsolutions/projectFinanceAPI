...
<form:form action="capproveCustomerHeadSave" name="approveCustomerHeadSave" commandName="customerHeadForm" onsubmit="return validateForm();">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<form:hidden path="id"  />
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="aStatus" readonly="true" id="status" placeholder="Enter Comment"></form:input>
									</td>															
									</tr>
									<tr>
					...
					<table align="center">
						<tr>
							...
							<td><a href="customerHeadCApprovalList" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
									</div>
