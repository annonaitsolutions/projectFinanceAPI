...
<form:form name="myForm" action="confirmUpdatesellerBankDiffrentEvent" method="post"  onsubmit="validateForm();" commandName="sellerDiffBankEventForm">	
		...
		<c:forEach items="${model.invoiceDocForms}" var="status">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">&nbsp;</div>
					...
					<tr >
						...
						<td class="col-sm-6"><form:select path="status">
					...
					<tr>
						<td class="col-sm-6"><spring:message code="label.comment"/></td>
						<td class="col-sm-6"><form:textarea path="comment" id="comment" rows="5" cols="20"/></td>
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							...
							<td><a href="sellerBankDiffrentEventPage" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
		</form:form>
