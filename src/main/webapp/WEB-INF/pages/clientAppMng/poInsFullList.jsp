			...
			<table class="table data jqtable example" id="my-table">
				...
				<tbody>
					<c:if test="${! empty dispute}">
						<c:forEach items="${dispute}" var="master">
							<tr>
								...
								<td><a href="addOrModifyReportAppMngView?id=${master.id}" class="btn btn-primary" onclick="return confirm();"><spring:message code="label.view"/></a></td>
								<td><a href="addOrModifyReportAppMngCompare?id=${master.id}" class="btn btn-primary" onclick="return confirm();"><spring:message code="label.compare"/></a></td>
							</tr>
						</c:forEach>
					</c:if>
