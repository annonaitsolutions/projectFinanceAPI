...
<div class="col-sm-9 col-sm-9 col-lg-9 body_fixed">
		...
		<div class="col-sm-12 col-sm-12 col-lg-12 header_customer">
					...
					<c:if test="${! empty customerList}">
						<c:forEach items="${customerList}" var="customer">
							<tr>
								...
								<td><c:out value="${customer.roleType}"></c:out></td>
								<td><c:out value="${customer.address}"></c:out></td>
								<td><c:out value="${customer.aStatus}"></c:out></td>



								<td><a href="capproveCustomerBranch?id=${customer.id}"
