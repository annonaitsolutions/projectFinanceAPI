...
<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
		...
		<h3><spring:message code="label.changePass"/></h3>
					...
					<form:form action="updateEditCustAppPWD" name="editProfile" autocomplete="off" onsubmit="return validateForm()" commandName="endUserForm" >
				...
				<div id="confirmNewPasswordError" style="display: none; color: red;"><spring:message code="label.passVal2"/></div>
								...
								<tr>
									...
									<a href="clientApprMng" class="btn btn-success" ><spring:message code="label.back"/></a></td>
								</tr>
