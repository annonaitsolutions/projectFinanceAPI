<%@include file="taglib_includes.jsp" %>
  <div class="col-sm-9 col-sm-9 col-lg-9 body_fixed">
		<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
            <h3><spring:message code="label.buyerSameBankDetails"/></h3>  
           </div>
           ...
           <div class="col-sm-12 col-md-12 col-lg-12">
			...
			<table class="table data jqtable example" id="my-table">
              <thead>
                ...
                <tbody>
                 <c:if test="${! empty buyerSamebankList}">
                 <c:forEach items="${buyerSamebankList}" var="buyerSameBankEvents"> 
                <tr>
					     ...
					     <td><a href="updatesameBankEvent?id=${buyerSameBankEvents.id}" class="btn btn-primary">Select</a></td>
                </tr>
                </c:forEach>
                </c:if>
