...
<form:form action="clientMasterPlanApproveStatusPost" name="bankMasterPlanApproveStatusPost" method="post" commandName="masterPlanForm" onsubmit="return validateForm();">
		<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
