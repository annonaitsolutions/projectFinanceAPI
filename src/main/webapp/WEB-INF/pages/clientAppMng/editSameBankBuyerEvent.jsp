...
<script>
 ...
 <div class="col-sm-9 col-sm-9 col-lg-9 body_fixed">
			 <div class="col-sm-12 col-md-12 col-lg-12 header_customer">
        		 <h3 style="text-align:center;"><spring:message code="label.eventsTable"/></h3> 
        	 </div>
            <form:form action="confirmEditsameBankEvent" name="myForm" onsubmit="return validateForm();" commandName="buyersameBankForm">  
				...
				<table align="center" width="400">
					<tr>
						...
						<td><form:select path="status">
							<form:option cssStyle="color:green" value="Approved"></form:option>
							<form:option cssStyle="color:red" value="Rejected"></form:option>
							</form:select>
					...
					<tr>
						...
						<td><form:textarea path="comment" id="comment" rows="5" cols="20"/></td>
					</tr>
					<tr>
