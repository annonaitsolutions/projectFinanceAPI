...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
					<form:form action="confirmEditCustAppProfile" name="editProfile" autocomplete="off" commandName="endUserForm" onsubmit="return val();">
						...
						<div id="contactNoError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>	
							...
							<div id="altContactNoError" class="error" style="display:none"><spring:message code="label.validation"/></div>
								...
								<tr>
									<td colspan="2">
									<a href="editCustAppPWD?id=${model.user.id}" style="color: #E09340;"><spring:message code="label.changePassword"/></a>
