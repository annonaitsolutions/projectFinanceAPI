...
<div class="col-sm-6 col-md-9 col-lg-9 body_fixed">
				...
				<form:form action="addOrModifyBuyerReportConfirm" method="post" commandName="disputeReportsForm" enctype="multipart/form-data"  name="interest" onsubmit="return val();">
				...
				<table align="center">
					<tr>
						...
						<td class="col-sm-6">
							...
							<div id="customerNameError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div></td>
					</tr>
					
					<tr>
						<td class="col-sm-6"><b><spring:message code="label.buyerName"/></b><span style="color:red"></span></td>
						<td class="col-sm-6">
							<form:input path="buyerName" readonly="true" class="form-control" placeholder="Enter Email"  id="supplierName"/>
							<div id="supplierNameError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="col-sm-6">
							<form:input path="invoicekey" readonly="true" class="form-control" placeholder="Enter PO Key"  id="pokey"/>
							<div id="pokeyError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
						</td>
					</tr>
				</table>
			</div>		
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
				...
				<table align="center">
					<tr>	
						...
						<td class="col-sm-6">
							<form:select path="transportType"  class="form-control" placeholder=""  id="transportType" style="width:205px;">
							<form:option value=""><spring:message code="label.selectValue"/></form:option>
								...
								<div id="transportTypeError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.plzSelectValue"/></font></div>
						</td>
					</tr>	
					<tr>	
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
				...
				<table align="center">
					...
					<tr>	
						...
						<td class="col-sm-6">
							<form:input path="surveyorName"  class="form-control"  id="supplierName"/>
							<div id="surveyorEmailError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
						</td>
					</tr>
						...
						<td class="col-sm-6">
							<form:input path="surveyorCom"  class="form-control"  id="supplierName"/>
							<div id="surveyorEmailError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
						</td>
					</tr>
						<tr>	
						...
						<td class="col-sm-6">
							<form:input path="surveyorAdd"  class="form-control"  id="supplierName"/>
							<div id="surveyorEmailError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
						</td>
					</tr>
						<tr>	
						...
						<td class="col-sm-6">
							<form:input path="surveyorEmail"  class="form-control"  id="surveyorEmail"/>
							<div id="surveyorEmailError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
						</td>
					</tr>
						<tr>	
						...
						<td class="col-sm-6">
							<form:input path="surveyorPhone"  class="form-control"  id="surveyorPhone"/>
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
				...
				<table align="center">
					...
					<tr>	
						...
						<td class="col-sm-6">
							<form:select path="defectType"  class="form-control" placeholder=""  id="goods" style="width:205px;">
							<form:option value=""><spring:message code="label.selectValue"/></form:option>
								...
								<div id="surveyorEmailError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.plzSelectValue"/></font></div>
						</td>
					</tr>	
						...
						<td class="col-sm-6">
							<form:input path="defectQty"  class="form-control"  id="defectQty"/>
						...
						<td class="col-sm-6">
							<form:input path="defectCostForGoods"  class="form-control"  id="supplierName"/>
							<div id="surveyorEmailError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
						</td>
					</tr>
						<tr>	
						...
						<td class="col-sm-6">
							<form:select path="damageStatus"  class="form-control" placeholder=""  id="goods" style="width:205px;">
							<form:option value=""><spring:message code="label.selectValue"/></form:option>
					...
					<tr>	
						...
						<td class="col-sm-6">
							<form:select path="replacement"  class="form-control" placeholder=""  id="goods" style="width:205px;">
							<form:option value=""><spring:message code="label.selectValue"/></form:option>
					...
					<tr>	
						...
						<td class="col-sm-6">
							<form:input path="repairCost"  class="form-control"  id="repairCost"/>
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							...
							<td><a href="invoiceDisputeReports" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
	...
	<script>
	function val(){
					var repairCost  = document.getElementById('repairCost');
					var defectQty  = document.getElementById('defectQty');
					var number='^\\d+$';
				...
				if(repairCost.value.match(/(^-?\d\d*\.\d\d*$)|(^-?\.\d\d*$)/) || repairCost.value.match(/^-?[0-9]+$/)  && !(document.getElementById('repairCost').value == ''))
			  	{
				...
				if(defectQty.value.match(/(^-?\d\d*\.\d\d*$)|(^-?\.\d\d*$)/) || defectQty.value.match(/^-?[0-9]+$/) && !(document.getElementById('defectQty').value == ''))
			  	{
