			...
			<table class="table data jqtable example" id="my-table">
				<thead>
					<tr>
						...
						<th><spring:message code="label.goodsStatus"/></th>
					...
					<c:if test="${! empty invoiceList}">
						<c:forEach items="${invoiceList}" var="master">
							<tr>
								...
								<td><c:out value="${master.goodsStatus}"></c:out></td>
								<td><c:out value="${master.quantity}"></c:out></td>
								<td><c:out value="${master.insuranceDetails}"></c:out></td>
								<td><c:out value="${master.insuranceAmount}"></c:out></td>
								<td><c:out value="${master.startDate}"></c:out></td>
								<td><c:out value="${master.endDate}"></c:out></td>
								<td><a href="custWareHouseBuyerREceived?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.received"/></a></td>
