<%@include file="taglib_includes.jsp"%>
 <div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
			 ...
			 <div class="col-sm-12 col-md-12 col-lg-12 header_customer">
				<div class="p_content">
					<form:form action="confirmEditBuyerProfile" name="editProfile" autocomplete="off" commandName="endUserForm" onsubmit="return val();">
						...
						<div id="contactNoError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>	
							...
							<div id="altContactNoError" class="error" style="display:none"><spring:message code="label.validation"/></div>
								...
								<tr>
									<td colspan="2">
									<a href="editBuyerPWD?id=${model.user.id}" style="color: #E09340;"><spring:message code="label.changePassword"/></a>
