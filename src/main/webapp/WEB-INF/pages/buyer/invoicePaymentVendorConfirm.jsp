...
<form:form  action="invoicePaymentBuyerSave" name="myForm" commandName="invoiceForm" onsubmit="return val();">
		...
		<div class="col-sm-12 col-md-12">	
					<div class="col-sm-12 col-md-12">
								...
								<tr>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="typeOfTransaction" placeholder="Enter name" readonly="true"></form:input>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="chequeNum" readonly="true" placeholder="Enter contact number" id="customerPrefix"></form:input>
					...
					<table align="center">
						<tr>
							...
							<td><a href="invoicePaymentBuyerList" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
