...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
			...
			<form:form action="updateWareHouseMngConfirm" commandName="wareHouseMngForm" onsubmit="return val()">
		  ...
		  <div class="col-sm-12 col-md-6 col-lg-6">
							...
							<table class="theader broad">
								...
								<tr>
									...
									<td class="col-sm-7"><form:input path="country" value="${model.wareHouseMngForm.country}" placeholder="Enter country" id="country"></form:input></td>
									<td id="countryError" class="error" style="display:none;"><font color="red"><spring:message code="label.validation"/>*</font></td>
									<td id="countryError" class="error" style="display:none"><spring:message code="label.validation"/></td>

								</tr>
								<tr>
									<td class="col-sm-5"><b><spring:message code="label.state"/></b><span style="color:red">*</span></td>
									<td class="col-sm-7"><form:input path="state" value="${model.wareHouseMngForm.state}" placeholder="Enter state" id="state"></form:input></td>
									<td id="stateError" class="error" style="display:none;"><font color="red"><spring:message code="label.validation"/>*</font></td>
									<td id="stateError" class="error" style="display:none"><spring:message code="label.validation"/></td>
							...
							<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<a href="createWareHouseMng" class="btn btn-success"   onclick="javascript:window.location='#';"/><spring:message code="label.back"/></a>
								</p>
							</div>
