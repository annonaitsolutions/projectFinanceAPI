...
/* document.msplan.masterkey.value=uuid; */
 ...
 /* var d1 = new Date().getTime();
  ...
  <div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
   ...
   <form:form action="draftsMasterPlanInfoConfirm" name="msplan" method="post" onsubmit="return validateForm()" commandName="masterPlanForm">
	...
	<tr>
						<td class="col-sm-6"><b><spring:message code="label.goodsCategory"/></b><span
							...
							<td class="col-sm-6"><form:select path="category" id="category" style="width:205px;">
								...
								<div id="categoryError" style="display: none; color: red;"><spring:message code="label.validation"/></div></td>
						</tr>
						<tr>
							...
							<td class="col-sm-6"><form:input path="product" id="product" />
								...
								<div id="productError" style="display: none; color: red;"><spring:message code="label.validation"/></div></td>
						</tr>
						...
						<tr>
							...
							<td class="col-sm-6"><form:input path="description" id="description" />
								...
								<div id="descriptionError" style="display: none; color: red;"><spring:message code="label.validation"/></div></td>
						</tr>
							<tr>
						...
						<tr>
							...
							<td class="col-sm-6"><form:input path="weight" id="weight" />
								<div id="weightError" style="display: none; color: red;">
									<spring:message code="label.validation"/></div>
								<div id="weightError" style="display: none; color: red;">
									<spring:message code="label.validation"/></div></td>
						</tr>
						<tr>
		...
		<table align="center">
						...
						<tr>
							...
							<td><form:input path="buyingCost" id="buyingCost" />
								<div id="buyingCostError" style="display: none; color: red;"><spring:message code="label.validation"/>
									</div>
								<div id="buyingCostError" style="display: none; color: red;"><spring:message code="label.validation"/>
									</div>
									</td>
					<c:choose>
						...
						<%-- <tr>
							...
							<td><form:input path="tenure" id="tenure" />
								<div id="tenureError" style="display: none; color: red;"><spring:message code="label.validation"/>
									</div>
								<div id="tenureError" style="display: none; color: red;"><spring:message code="label.validation"/>
									</div></td>
						</tr> --%>
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.workingCapital"/></b>
								</td>
							<td><form:input path="workingCapital" id="workingCapital" />
								</td>
								<td>${symbol}</td>
						...
						<%-- <tr>
							<td class="col-sm-6"><b><spring:message code="label.tenure"/></b>
								</td>
							<td><form:input path="WcTenure" id="WcTenure" />
								</td>
						</tr>
 --%>						<tr>
							<td class="col-sm-6"><b><spring:message code="label.sellingCost"/></b>
								</td>
							<td><form:input path="sellingCost" id="sellingCost" />
								</td>
								<td>${symbol}</td>
						</tr>
						<%-- <tr>
							...
							<td><form:input path="sellingTenure" id="sellingTenure" />
								</td>
						</tr> --%>
						<form:hidden path ="masterKey" value="" id="masterkey"/>
						<form:hidden path ="transactionId" value="" id="transactionId"/>
			...
			<div class="col-sm-12 col-md-12">&nbsp;</div>
					...
					<table align="center">
						<tr>
							...
							<td><a href="masterPlanDraftsList" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
