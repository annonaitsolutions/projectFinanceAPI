              ...
              <thead>
                ...
                <tr>
                    ...
                    <td><c:out value="${buyerDiffBankEvents.supplierBank}"></c:out></td>
						 ...
						 <td><c:out value="${buyerDiffBankEvents.date1}"></c:out></td>
						 <td><c:out value="${buyerDiffBankEvents.event1}"></c:out></td>
						 <td><c:out value="${buyerDiffBankEvents.status}"></c:out></td>
						 <td><c:out value="${buyerDiffBankEvents.customerStatus}"></c:out></td>
					
					<td><a href="selectSendingDiffBankEvents?id=${buyerDiffBankEvents.id}" class="btn btn-primary"><spring:message code="label.select"/></a></td>
                </tr>
                </c:forEach>
                </c:if>
