...
<form:form action="invoiceForRenewelConfirm" commandName="invoiceForm" onsubmit="return val();">
					...
					<table align="center">
						<tr>
							...
							<td><a href="invoiceListForRenewel" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
