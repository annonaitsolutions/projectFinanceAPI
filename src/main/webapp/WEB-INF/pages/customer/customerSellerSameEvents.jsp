<%@include file="taglib_includes.jsp" %>
 <div class="container">
    <div class="row">
        <div class="col-md-12">
           <h3 align="center" style="color: #2E9AFE;font-size: 19px; font-weight: 400;margin-top: -4px;text-transform: uppercase;"><spring:message code="label.sellerSameBankDetails"/></h3>    
              ...
              <thead>
                ...
                <tr>
                    ...
                    <td><c:out value="${sellerSameBankEvents.buyerBank}"></c:out></td>
						 ...
						 <td><c:out value="${sellerSameBankEvents.customerStatus}"></c:out></td>
					
					<td><a href="selectCustomerSellerSameBankEvents?id=${sellerSameBankEvents.id}" class="btn btn-primary"><spring:message code="label.select"/></a></td>
                </tr>
                </c:forEach>
                </c:if>
