...
<form:form  action="poPaymentHeadAdvanceSave" name="myForm" commandName="purchaseOrderForm" onsubmit="return val();">
						...
						<form:hidden path="id"  />
							...
							<tr>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="chequenum" readonly="true" placeholder="Enter Cheque Number" id="customerPrefix"></form:input>
											
									</tr>
									<tr>
										<td class="col-sm-6"><b><spring:message code="label.signAuth"/>:</b></td>
										<td class="col-sm-6"><form:input path="signAuth" readonly="true" placeholder="Enter Cheque Number" id="customerPrefix"></form:input>
											
									</tr>
									<tr>
										<td class="col-sm-6"><b><spring:message code="label.amtLimit"/>:</b></td>
										<td class="col-sm-6"><form:input path="amtLimit" readonly="true" placeholder="Enter Cheque Number" id="customerPrefix"></form:input>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="payNow" readonly="true" id="payNow"></form:input>
