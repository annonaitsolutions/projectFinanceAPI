...
<script type="text/javascript">
	...
	function addRow1(tableID1) {
		...
		for (var i = 0; i < colCount; i++) {
			...
			switch (newcell.childNodes[3].type) {
			case "text":
 ...
 <script>
	$(document).ready(function() {
 	var l="${draftBuyingCostList}"; 
	 var countries = document.getElementsByName("country");
	 var hiddencountries = document.getElementsByName("hiddenCountry");
	 
	 /* countries[0].value="India"; */
		for (var i = 0; i < countries.length; i++) {
			/* console.log(l[i]); */
 			countries[i].value = hiddencountries[i].value; 
		}   
	});
</script> 
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
	<form:form action="draftsMasterPlanInfoPost" name="msplan"
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			<table class="host-list" id="dataTable">
				...
				<c:if test="${not empty draftBuyingCostList}">
					<c:forEach items="${draftBuyingCostList}" var="draftBuyingCost">
						...
						<tr>
							<td>
								...
								value="${draftBuyingCost.supplierName}">
							...
							<td>
								...
								value="${draftBuyingCost.material}">
							</td>
							...
							<div id="countryError" class="error"
								style="display: none; color: red;">
								<spring:message code="label.multipleRowVal" />
							</div> <select id=country_${draftBuyingCost.id} name="country"></select> <script>
								populateCountries("country_${draftBuyingCost.id}");
							</script>
							<input hidden="true" name="hiddenCountry" value="${draftBuyingCost.country}">
						</td>
							...
							<td>
								...
								style="width: 111px;" value="${draftBuyingCost.quantity}">
							</td>
							<td>
								...
								style="width: 111px;" value="${draftBuyingCost.cost}">
							</td>
						</tr>
				...
				<c:if test="${ empty draftBuyingCostList}">
					<tr>
						<td>
							<div id="supplierNameError" class="error"
								style="display: none; color: red;">
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			<table class="host-list" id="dataTable1">
				...
				<c:if test="${not empty draftSellerBuyingCostList}">
					<c:forEach items="${draftSellerBuyingCostList}"
						var="draftSellerBuyingCost">
						<tr>
							<td>
								<div id="buyerNameError" class="error"
									style="display: none; color: red;">
									<spring:message code="label.multipleRowVal" />
								</div> <input type="text" name="buyerName" id="buyerName"
								value="${draftSellerBuyingCost.buyerName}">
							</td>
							...
							<td>
								<div id="finalProError" class="error"
									style="display: none; color: red;">
									<spring:message code="label.multipleRowVal" />
								</div> <input type="text" name="finalPro" id="finalPro"
								value="${draftSellerBuyingCost.finalPro}">
							</td>
							...
							<td>
								<div id="qtyStrError" class="error"
									style="display: none; color: red;">
									<spring:message code="label.multipleRowVal" />
								</div> <input type="text" name="qtyStr" id="qtyStr"
								style="width: 111px;" value="${draftSellerBuyingCost.quantity}">
							</td>
							<td>
								<div id="amtStrError" class="error"
									style="display: none; color: red;">
									<spring:message code="label.multipleRowVal" />
								</div> <input type="text" name="amtStr" id="amtStr"
								style="width: 111px;" value="${draftSellerBuyingCost.amt}">
							</td>
							<td>
								<div id="costperUnitError" class="error"
									style="display: none; color: red;">
									<spring:message code="label.multipleRowVal" />
								</div> <input type="text" name="costperUnitStr" id="costperUnitStr"
								style="width: 111px;"
								value="${draftSellerBuyingCost.costperUnit}">
							</td>
						</tr>
					</c:forEach>
				</c:if>
				<c:if test="${empty draftSellerBuyingCostList}">
					<tr>
						<td>
							<div id="buyerNameError" class="error"
								style="display: none; color: red;">
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			<table class="host-list" id="dataTable2">
				...
				<c:if test="${not empty draftWorkingCapitalList}">
					<c:forEach items="${draftWorkingCapitalList}"
						var="draftWorkingCapital">
						<tr>
							<td>
								...
								value="${draftWorkingCapital.reason}">
							</td>
							...
							<td>
								...
								value="${draftWorkingCapital.amount}">
							</td>
				...
				<c:if test="${ empty draftWorkingCapitalList}">
					<tr>
						<td>
							<div id="wcReasonError" class="error"
								style="display: none; color: red;">
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			<table align="center">
				<tr>
					...
					<td><a href="masterPlanDraftsList" class="btn btn-success"><spring:message
