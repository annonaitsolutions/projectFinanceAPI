...
<form:form action="masterPlanRePaymentSave" name="customerHeadSave" commandName="repaymentForm" onsubmit="return validateForm();">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
								<table align="center">
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="amtType" readonly="true" placeholder="Enter contact number" id="amtType"></form:input></td>
									...
									<tr class="workingCapital">
										...
										<td class="col-sm-6"><form:input path="wcSancAmount" readonly="true" placeholder="Enter contact number" id="customerPrefix"></form:input></td>
											
									</tr>
									
									<tr class="workingCapital">
										<td class="col-sm-6" ><b><spring:message code="label.interest"/>:</b></td>
										<td class="col-sm-6"><form:input path="wcTotalInterest" readonly="true" placeholder="Enter contact number" id="customerPrefix"></form:input></td>
					...
					<table align="center">
						<tr>
							...
							<td><a href="masterPlanRePayment" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
									</div>
