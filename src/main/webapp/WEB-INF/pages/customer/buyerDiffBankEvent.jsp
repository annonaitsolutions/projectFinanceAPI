...
div#ui-datepicker-div {
 ...
 <div class="col-sm-9 col-sm-9 col-lg-9 body_fixed">
		 <div class="col-sm-12 col-md-12 col-lg-12 header_customer">
			 <h3 style="text-align:center"><spring:message code="label.eventsTablePoDifferentBank"/></h3>
		 </div>
		<form:form name="event" action="confirmBuyerDiffBankEvent" method="post" commandName="buyerDiffBankEventForm" onsubmit="return validateForm();">
		...
		<table class="table-bordered theme">
			...
			<tbody>
				<tr>
					<td>1</td>
					<td><form:input  value="1" size="3" style="width:60px;" path="first"/></td>
					<td id="e1"><form:input path="date1" id="datepicker" class="form-control" placeholder="Select date" style="width: 111px;" readonly="true"/><i class="fa fa-calendar"></i>
					<div id="date1Error" style="display: none; color: red;">
						<spring:message code="label.validation3"/></div>
						<div id="date1Error" style="display: none; color: red;">
						<spring:message code="label.validation3"/></div> 
					</td>
			    ...
			    <tr>
					...
					<td><form:hidden path="event2" value="${model.purchaseOrder.customerName} sends a Purchase Order to ${model.purchaseOrder.supplierName}"/>
				...
				<tr>
					<td>5</td>
					<td> <form:input size="3" style="width:60px;" id="fifth" path="fifth" onchange="myFunc(document.getElementById('fourth').value,document.getElementById('fifth').value,'date5')"/></td>
				...
				<tr>
				 ...
				 <tr>
					...
					<td><form:hidden path="event7" value="${model.purchaseOrder.supplierBank} receives documents and forwards it to ${model.customerBankName} for payment"/>
					<p>${model.purchaseOrder.supplierBank} receives documents and forwards it to ${model.customerBankName} for payment</p></td>
				 ...
				 <tr>
					...
					<td><form:hidden path="event8" value="${model.customerBankName} receives documents intimates ${model.purchaseOrder.customerName} for Acceptance of Documents"/>
					<p>${model.customerBankName} receives documents intimates ${model.purchaseOrder.customerName} for Acceptance of Documents</p></td>
				...
				<tr>
					...
					<td><form:hidden path="event9" value="${model.purchaseOrder.customerName} accepts Bill of Exchange and takes the documents to release the ${model.purchaseOrder.goods}"/>
				...
				<tr>
					...
					<td><form:hidden path="event10" value="${model.customerBankName} remits funds to ${model.purchaseOrder.supplierBank}"/>
					<p>${model.customerBankName} remits funds to ${model.purchaseOrder.supplierBank}</p></td>
				...
				<tr>
					...
					<td><form:hidden path="event11" value="${model.purchaseOrder.supplierBank} Credits ${model.purchaseOrder.supplierName} Account"/>
					<p>${model.purchaseOrder.supplierBank} Credits ${model.purchaseOrder.supplierName} Account</p></td>
				...
				<tr>
					...
					<td><form:hidden path="event12" value="${model.purchaseOrder.customerName} Receives ${model.purchaseOrder.goods} and starts to process it to finished products"/>
				...
				<tr>
					...
					<td><form:hidden path="event13" value="TRANSACTION ENDS"/>
