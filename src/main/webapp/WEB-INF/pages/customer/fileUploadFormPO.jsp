...
<div class="col-sm-9 col-sm-9 col-lg-9 body_fixed">
	...
	<form:form method="post" enctype="multipart/form-data"
		name="fileUploadPO" commandName="poUploadForm" action="fileUploadPO"
		...
		<div class="mastersub">
			<h3 align="center"
				...
				<spring:message code="label.newPoUploadDocs" />
			</h3>
		</div>
		<div class="col-sm-12 col-md-12 col-lg-12">
			<table align="center">
				...
				<tr>
					<td class="col-sm-6"><b><spring:message
								code="label.reasonForUpload" /></b><span style="color: red">*</span></td>
					<td class="col-sm-6"><form:input path="reason" id="reason"
							placeholder="Enter reason" style="width: 207px;" />
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			<table align="center">
				<tr>
					...
					<td><a href="poApprovedList" class="btn btn-success"><spring:message
	...
	function validateForm() {
		...
		var canSubmit = true;
		 ...
		 if (document.getElementById('reason').value == '') {
			...
			document.fileUploadPO.transactionId.value = uuid; */
		if (canSubmit == false) {
			return false;
		}
	}
