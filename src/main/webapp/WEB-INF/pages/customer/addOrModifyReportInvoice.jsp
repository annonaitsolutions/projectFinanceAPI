...
<div class="col-sm-6 col-md-9 col-lg-9 body_fixed">
				...
				<form:form action="addOrModifyReportInvoiceConfirm" method="post" commandName="disputeReportsForm" enctype="multipart/form-data"  name="interest" onsubmit="return val();">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
				...
				<table align="center">
					<tr>	
						...
						<td class="col-sm-6">
							<form:select path="transportType"  class="form-control" placeholder=""  id="goods" style="width:205px;">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							...
							<td><a href="addOrModifyReportCustList" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
