...
<form:form action="updateCustWareHouseConfirm" method="post" commandName="wareHouseForm" onsubmit="return val();">
	 <div  class="successMsg"><b><font color="green">${success}</font></b></div>
		...
		<div class="col-sm-12 col-md-12 col-lg-12 newcustomer_border">
			<div class="content col-sm-12 col-md-12 col-lg-12">
								<table align="center">
								<caption><spring:message code="label.whDetails"/></caption>
								<form:hidden path="id"/>
									<tr>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="wareHouseName" id="wareHouseName" ></form:input>
								...
								<tr>
										...
										<td class="col-sm-6"><form:input path="personInCharge" id="personInCharge" ></form:input>
									...
									<tr>	
											...
											<td class="col-sm-6"><form:input path="address"  id="address"></form:input>
									...
									<tr>
											...
											<td class="col-sm-6"><form:input path="pinCode"  id="pincode"></form:input>
									...
									<tr>
											...
											<td class="col-sm-6"><form:input path="capacity"  id="capacity"></form:input>
									...
									<tr>
											...
											<td class="col-sm-6"><form:input path="size"  id="size"></form:input>
