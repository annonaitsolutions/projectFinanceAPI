...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
				...
				p=parseFloat(document.interest.totalCost.value).toFixed(2);
                r=parseFloat(document.interest.weight.value).toFixed(2);
                t= parseFloat(document.interest.fullyDamagedQty.value);
                i=p/r;
                s=t*i;
                document.interest.fullyDamagedCost.value= s.toFixed(2);
				}  
...
<div class="col-sm-6 col-md-9 col-lg-9 body_fixed">
				...
				<form:form action="disputeHeadConfirm" method="post" commandName="disputeForm" enctype="multipart/form-data"  name="interest" onsubmit="return val();">
			...
			<div class="col-sm-6 col-md-6 col-lg-6">
				...
				<table align="center">
					...
					<tr>	
						<td id="customerError" style="display:none;color:red;"><font color="red"><spring:message code="label.nameVal"/></font></td>
					        <td id="customerError" style="display:none;color:red;"><spring:message code="label.validation"/>
					        </td>
					</tr>
					<tr>
			...
			<div class="col-sm-12 col-md-12 col-lg-12">	
				...
				<table align="center">				
					<tr>	
						...
						<td class="col-sm-6">
							...
							<form:option value=""><spring:message code="label.selectGoodsCategory"/></form:option>
					...
					<tr>	
						...
						<td class="col-sm-6">
							<form:input path="goodsInfo"  class="form-control" placeholder="Enter Goods Info"  id="goodsInfo"/>
				...
				<%-- 	<tr>	
					...
					<tr>
						<td class="col-sm-6"><input type="button" value="<spring:message code="label.costOfEachUnit"/>" class="btn btn-default" style="color:#2E9AFE;font-weight: 600;" onclick="Test();"></td>
						<td class="col-sm-6">
				...
				<%-- 	<tr>
						...
						<td class="col-sm-6">
							...
							<div id="goodsDefectError" style="display:none;color:red;"><spring:message code="label.validation"/></div>
					        <div id="goodsDefectError" style="display:none;color:red;"><spring:message code="label.validation"/></div>
						</td>
					</tr> --%>
					<tr>
					...
					<tr>
						...
						<td class="col-sm-6">
							<form:input path="noOfDefect" value="0" class="form-control" placeholder="Enter defect Percantage"  id="noOfDefect"/>
					...
					<tr>
						...
						<td class="col-sm-6">
							<form:input path="answer2" value="0" class="form-control" placeholder="Enter cost Of DefectiveGoods"  id="costDefectiveGoods"/>
