...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
				...
				<form:form action="disputeHeadUpdateConfirm" method="post" commandName="disputeForm" name="dispute"  onsubmit="return val();">
				...
				<form:hidden path ="id" />
						...
						<div id="customerError" style="display:none;color:red;"><font color="red"><spring:message code="label.nameVal"/></font></div>
					...
					<h3 style="font-size: 19px; font-weight: 400;"><spring:message code="label.disputeInfo"/></h3>
						...
						<div class="col-sm-9">
							...
							<form:option value=""><spring:message code="label.selectValue"/></form:option>
						     ...
						     <div id="disputeStatusError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
							<div id="disputeStatusError" class="error" style="display:none"><spring:message code="label.validation"/></div>
						</div>
