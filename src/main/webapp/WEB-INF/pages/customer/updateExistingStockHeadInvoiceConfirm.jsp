...
<form:form action="updateExistingStockHeadInvoice" method="post" name="interest" commandName="invoiceStockForm" onsubmit="return val();">
		...
		<div class="col-sm-12 col-md-12 col-lg-12 newcustomer_border">
			<div class="content col-sm-12 col-md-12 col-lg-12">
								...
								<tr>
									...
									<tr>
									<tr>
											<td class="col-sm-6"><b><spring:message code="label.damaged"/></b><span style="color:red">*</span></td>
