...
<form:form action="inventoryInvoiceShowConfirm" name="interest" commandName="inventoryForm" onsubmit="return Val();">
			...
			<%-- 	<tr>	
				...
				<tr>
					...
					<td class="col-sm-6"><form:input path="quantity" placeholder="Enter totalQuantity Quantity"/></td>
				...
				<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							...
							<td><a href="inventoryInvoiceList" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
									</div>
