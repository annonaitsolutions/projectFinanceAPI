			...
			<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
				...
				<table align="center" width="400">
					...
					<tr>
						...
						<td>${model.collateralForm.transactionId}</td>
					<tr>
						<td><b><spring:message code="label.transactionType"/></b></td>
						<td><spring:message code="label.collateral"/></td>
					</tr>

					<tr>
						<td><b><spring:message code="label.status"/></b></td>
						<td><font color="green"><spring:message code="label.receivedSuccessFully"/></font></td>
					</tr>
