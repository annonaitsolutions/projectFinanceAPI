...
<form:form action="generateInvoiceFromPOPost" method="post"
	...
	<div class="col-sm-6">
		<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
			<h3 align="center"><spring:message code="label.existingPoInfo"/></h3>
		</div>
		<table align="center">
...
<%--			</tr>--%>
	...
	<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<table align="center">
			...
			<tr>
				<td class="heading_text"><b><spring:message code="label.invoiceRemaining"/></b><span
						style="color: red">*</span></td>
				<td ><form:input readOnly="true" path="invoiceRemaining" id="invoiceRemaining"   />

			</tr>

			<tr>
				<td class="heading_text"><b><spring:message code="label.quantityForInvoice"/></b><span
						style="color: red">*</span></td>
				<td ><form:input readOnly="true" path="quantityForInvoice" id="quantityForInvoice" />
