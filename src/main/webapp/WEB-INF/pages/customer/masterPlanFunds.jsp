			...
			<table class="table data jqtable example" id="my-table">
				<thead>
					<tr>
						...
						<th><spring:message code="label.distribute"/></th>
						...
						<c:forEach items="${masterList}" var="master">
							<tr>
								...
								<td><a href="distributionFullDetails?id=${master.id}"
									...
									<td><a href="masterPlanFundsDistribute?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.distribute"/></a></td>
