...
<div class="col-md-9 col-sm-9 col-lg-9 body_fixed">
            ...
            <form:form action="confirmSelectUpdateSellerSameBankEvents" method="post" commandName="sellerSameBankEventForm">  
           ...
           <table align="center">
				...
				<tr>
					...
					<td class="col-sm-7"><form:input id="buyer" path="buyer" readonly="true"></form:input></td>
				</tr>
				<tr>
					<td class="col-sm-5"><b><spring:message code="label.buyerBank"/>:</b></td>
					<td class="col-sm-7"><form:input id="buyerBank" path="buyerBank" readonly="true"></form:input></td>
				</tr>
				<tr>
			...
			<tbody>
				<tr>
					...
					<td id="e1"><form:input path="date1" id="datepicker" readonly="true" style="width: 97px;"></form:input></td>
			   ...
			   <tr>
					...
					<td><form:select style="width: 575px;" path="event3"><form:option value="${model.sellerSameBankEvent.buyer} opens a Letter of Credit favouring ${model.sellerSameBankEvent.customerName}"/>
					<form:option value="${model.sellerSameBankEvent.buyer}  sells the ${model.sellerSameBankEvent.goods} on Open Account (Factoring)"></form:option>
					</form:select>
					</td>
				...
				<tr>
					...
					<td><form:select style="width: 575px;" path="event4"><form:option value="${model.sellerSameBankEvent.customerName} loads the ${model.sellerSameBankEvent.goods} in a Truck and sends it to ${model.sellerSameBankEvent.buyer} (Single modal)"/>
					<form:option value="${model.sellerSameBankEvent.customerName} loads the ${model.sellerSameBankEvent.goods} in a Ship/Rail/Truck and sends it to ${model.sellerSameBankEvent.buyer} (Multi  modal)"></form:option>
					</form:select>
					</td>
				...
				<tr>
					...
					<td id="e11"><form:input path="date11" id="date11" readonly="true" style="width: 97px;"></form:input></td>
				...
				<tr>
					...
					<td id="e12"><form:input path="date12" id="date12" readonly="true" style="width: 97px;"></form:input></td>
				...
				<tr>
					...
					<td id="e13"><form:input path="date13" id="date13" readonly="true"  style="width: 97px;"></form:input></td>
