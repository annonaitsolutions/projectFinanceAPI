...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
	...
	<form:form action="businessPlanForInvoiceConfirm" method="post" name="interest" commandName="invoiceForm" id="newBuyer" onsubmit="return val();">
		<div class="col-sm-6">
		...
		<div class="col-sm-6 col-md-6">
			...
			<table align="center">
				...
				<tr>
					...
					<td class="col-sm-6"><form:input path="poKey" placeholder="Enter PoKey" id="poKey" />
				...
				<tr>
					<td class="col-sm-6"><b><spring:message code="label.poDate"/></b><span
							style="color: red">*</span></td>
					<td class="col-sm-6"><form:input id="datepicker" path="poDate" placeholder="Enter PoDate"/>
