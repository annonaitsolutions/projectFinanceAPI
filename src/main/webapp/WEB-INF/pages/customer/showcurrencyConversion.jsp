...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
	<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<div class="col-sm-12 col-md-12 header_customer">
			<h3 align="center"><spring:message code="label.curConvert"/></h3>
		</div>
    <table align="center">
		<tr>
			<td class="col-sm-6">
		...
		<tr>
			...
			<td class="col-sm-6"><input type="text"placeholder="Enter Rate Of Exchange " name="principle" size="7"></td>
		</tr>
		...
		<tr>
			...
			<td class="col-sm-6"><input type="text"placeholder="Enter Enter Mark Up " value="0" name="rate" size="7"></td>
		</tr>
		
		<tr>
			<td class="col-sm-6"><spring:message code="label.amtToCalc"/></td>
			<td class="col-sm-6"><input type="text" placeholder="Enter Enter Amount To be Converted " name="value" size="7"></td>
		</tr>
		...
		<tr>
			...
			<td class="col-sm-6"><input type="text"  placeholder="Enter Convert Amount " name="answer" size="7"></td>
		</tr>
