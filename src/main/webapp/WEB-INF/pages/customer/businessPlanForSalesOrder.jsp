...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
		...
		<form:form action="businessPlanForSalesOrderConfirm" method="post" name="interest" commandName="salesOrderForm" id="newBuyer" onsubmit="return val();">
	<div class="col-sm-6">
		...
		<div class="col-sm-6 col-md-6">
				<div class="col-sm-12 col-md-12 col-lg-12 header_customer">	
					<h3><spring:message code="label.menuMasterPlan"/></h3>
				</div>	
					<table align="center">
					
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.masterPlanKey"/></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><form:input path="masterPlanKey" readOnly="true" value="${model.masterPlanForm.masterKey}" placeholder="Enter Master Plan Key" id="masterPlanKey" />
								<div id="masterPlanKeyError" style="display: none; color: red;"><spring:message code="label.validation"/></div>
							
						</tr>
						
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.masterplaneDate"/></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6">
<%--								<fmt:formatDate var="formattedDate" pattern="dd/MM/yyyy" value="${model.masterPlanForm.masterPlanDate}" />--%>
							 <form:input id="masterPlanDate" path="masterPlanDate" value="${model.masterPlanDate}" placeholder="Enter MasterPlan Date"/>
							</td>
<%--									 <fmt:formatDate value="${model.masterPlanForm.masterPlanDate}" pattern="dd/MM/yyyy" var="formattedDate"/>--%>
<%--									 <form:input path="accExpiryDate" class="form-control" placeholder="Select date" value="${formattedDate}"--%>
					...
					<table align="center">
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.goods"/></b><span
								style="color: red">*</span></td>
							 <td class="col-sm-6"><form:input path="goods" id="goods" value="${model.masterPlanForm.product}" readonly="true" placeholder="Enter Goods"/>
								<div id="goodsError" style="display: none; color: red;"><spring:message code="label.validation"/></div> 
									
						</tr>
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.details"/></b><span style="color: red">*</span></td>
							<td class="col-sm-6"><form:input path="goodsDetails" id="goodsDetails" value="${model.masterPlanForm.description}" placeholder="Enter Goods Details"/>
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.quantity"/></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><form:input path="quantity" id="quantity"  value="${model.purchaseOrderForm.quantity}"  placeholder="Enter Quantity"/>
						...
						<form:option value=""><spring:message code="label.select"/></form:option>
								<form:options items="${salesOrderForm.wareHouseList}"
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.weight"/></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><form:input path="weight" id="weight"  value="${model.masterPlanForm.weight}" placeholder="Enter Weight"/>
