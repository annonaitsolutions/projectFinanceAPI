	...
	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
		...
		<table  align="center">
			...
			<tr>
				...
				<td class="col-sm-6"><input type="text" name="rupee"  placeholder="Enter indRup" onChange="rupeeConverter()" /></td>
			</tr>
			<tr>
				<td class="col-sm-6"><b><spring:message code="label.saudi"/> : </b> </td>
				<td class="col-sm-6"><input type="text" name="riyal" placeholder="Enter saudi"  onChange="riyalConverter()" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><input type="button" value="<spring:message code="label.curConvert"/>" /></td>
			</tr>
		</table>
		</form>
	</div>
