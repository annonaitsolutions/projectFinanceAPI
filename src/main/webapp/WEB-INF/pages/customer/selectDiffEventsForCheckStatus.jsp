...
<div class="col-md-9 col-sm-9 col-lg-9 body_fixed">
		<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
			<h3 align="center"><spring:message code="label.buyerDifferentBankDeailsStatus"/></h3> 
		</div>
            <form:form action="" commandName="buyerDiffBankEventForm">  
		...
		<video id="eventsVideo" width="400" height="300" autoplay>
			...
			<tbody>
				<tr>
			      ...
			      <tr>
					<td>2</td>
					<td><form:input size="3"  path="second" style="width:60px" onchange="valid()" readonly="true"/></td> 
			   ...
			   <tr>
				...
				<tr>
					<td>12</td>
					<td> <form:input size="3" style="width:60px" path="twelve" onchange="valid10()" readonly="true"/></td>
				...
				<tr>
					<td>13</td>
					<td> <form:input size="3" style="width:60px" path="thirteen" onchange="valid11()" readonly="true"/></td>
		...
		<c:forEach items="${model.purchaseDocForms}" var="status">
			...
			<tr class="chargescolor">
				...
				<tr>
					...
					<table align="center">
						<tr>
							<td><a href="buyerDiffViewAllEvents3" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
   ...
   function myHandler(e) {	
      ...
      if(eventCount == 9) {  
    	  ...
    	  $(eventVideos).attr('src', "<%=request.getContextPath()%>/resources/videos/event111.mp4");
    	   ...
    	   $(eventVideos).attr('src', "<%=request.getContextPath()%>/resources/videos/event"+array[eventCount-1]+".mp4");
      }else {
