...
<form:form action="custWareHouseConfirm" method="post" commandName="wareHouseForm" onsubmit="return val();">
			...
			<div class="content col-sm-12 col-md-12 col-lg-12">
								<table align="center">
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="wareHouseName" id="wareHouseName" placeholder="Enter WareHouse Name"></form:input>
									...
									<tr>
						<td class="col-sm-6"><b><spring:message code="label.personInCharge"/><span style="color:red">&nbsp;*</span>&nbsp;:</b></td>
						<td class="col-sm-6"><form:select id="personInCharge" path="personInCharge"  style="width:205px;">
						<form:option value=""><spring:message code="label.selectValue"/></form:option>
							...
							<span id="personInChargeError" class="error" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></span>
									...
									<tr>
											...
											<td class="col-sm-6"><form:input path="capacity" placeholder="Enter Capacity" id="capacity"></form:input>
									...
									<tr>
											...
											<td class="col-sm-6"><form:input path="size" placeholder="Enter Size" id="size"></form:input>
					...
					<c:if test="${! empty whList}">
						<c:forEach items="${whList}" var="customer">
							<tr>
								...
								<td><a href="selectCustWareHouse?id=${customer.id}"
