...
<div class="col-sm-9 col-md-9 body_fixed">
				  ...
				  <table align="center" width="800" height="80" style="margin-top: 50px;">
					<tr>
						...
						<td>${model.masterPlanForm.transactionId}</td>
					<tr>
					...
					<tr>
						<td><b><spring:message code="label.note"/> :</b></td>
						<td><font color="orange"><spring:message code="label.noteMessage1"/> <font color="black"><spring:message code="label.or"/> <a href="masterPlanPending"><font color="red"><spring:message code="label.clickHere"/></a></font></td>
					</tr>
