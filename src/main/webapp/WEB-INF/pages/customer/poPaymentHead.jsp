...
$( document ).ready(function() {	
	$("#chequeNum").hide();
				...
				function val(){
					...
					if (document.getElementById('typeOfTrans').value == 'LC'){
						document.getElementById('typeOfTransError').style.display='block';
						document.getElementById('chequenum').style.display='none';
						canSubmit = true;
					}
					if (document.getElementById('typeOfTrans').value == 'BG'){
						document.getElementById('typeOfTransError').style.display='block';
						document.getElementById('chequenum').style.display='none';
						canSubmit = true;
					}
...
<div class="col-sm-9 col-md-9 body_fixed">
	<div class="col-sm-12 col-md-12 header_customer">
		<h3 align="center">
			<spring:message code="label.poPayment" />
		</h3>
	</div>
	<form:form action="poPaymentHeadConfirm" name="myForm"
		commandName="purchaseOrderForm" onsubmit="return val();">
		...
		<div class="col-sm-12 col-md-12">
			<div class="col-sm-12 col-md-12">
				<table align="center">
					...
					<tr>
						<td class="col-sm-6"><b><spring:message
									code="label.customerHeadName" />:</b></td>
						<td class="col-sm-6"><form:input path="customerHeadName"
								readonly="true"></form:input>
					</tr>
					<tr>
						<td class="col-sm-6"><b><spring:message
									code="label.supplierName" />:</b></td>
					...
					<tr>
						<td class="col-sm-6"><b><spring:message
									code="label.poKey" />:</b></td>
						<td class="col-sm-6"><form:input path="poKey" readonly="true"
								id="customerPrefix"></form:input>
					</tr>

					<tr>
						<td class="col-sm-6"><b><spring:message
									code="label.amount" />:</b></td>
						<td class="col-sm-6"><form:input path="amount"
								readonly="true" id="customerPrefix"></form:input>
					</tr>
					<tr>
						<td class="col-sm-6"><b><spring:message
									code="label.balance" />:</b></td>
						<td class="col-sm-6"><form:input path="payBalance"
								readonly="true" id="customerPrefix"></form:input>
					</tr>
					<tr>
						<td class="col-sm-6"><b><spring:message
									code="label.typeOfPayment" />:</b><span style="color: red">*</span></td>

						<td class="col-sm-6"><form:select path="typeOfTrans"
								id="typeOfTrans" style="width:205px;" >
								<form:option value="">
									<spring:message code="label.selectValue" />
								</form:option>
								<form:option value="transfer">
									<spring:message code="label.fundsTransfer" />
								</form:option>
								<form:option value="Cheque">
									<spring:message code="label.cheaque" />
								</form:option>
								<form:option value="DD">
									<spring:message code="label.demandDraft" />
								</form:option>
								<form:option value="Cash"><spring:message code="label.cash"/></form:option>
								<form:option value="LC">
									<spring:message code="label.lc" />
								</form:option>
								<form:option value="BG">
									<spring:message code="label.bg" />
								</form:option>
							</form:select>
						<td id="typeOfTransError" class="error" style="display: none;"><font
							color="red"><spring:message code="label.plzSelectValue" /></font></td>
						<td id="typeOfTransError" class="error" style="display: none"><spring:message
			...
			<div class="col-sm-12 col-md-12 col-lg-12">
				<table align="center">
					<tr>
						...
						<td><a href="poPaymentHeadList" class="btn btn-success"><spring:message
