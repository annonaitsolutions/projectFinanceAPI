...
<%@taglib uri="http://www.springframework.org/tags" prefix="spring"%>
	...
	<div class="col-sm-12 col-md-12 header_customer">
		<h3><spring:message code="label.lcBg"/></h3>
	</div>
					...
					<div class="col-sm-12 col-md-6">
						...
						<form:hidden path="id"  />
								...
								<tr>
										...
										<td class="col-sm-7"><form:input path="typeOfTrans" readonly="true" placeholder="Enter Transection Type" id="customerPrefix"></form:input>
											
									</tr>
								
								<tr>
										<td class="col-sm-5"><b><spring:message code="label.typeOfLc"/>:</b>
								...
								<div class="col-sm-12 col-md-6">	
									<table class="theader">
										<tr>
										<td class="col-sm-5"><b><spring:message code="label.typeOfBank"/>:</b>
									...
									<tr>
										<td class="col-sm-5"><b><spring:message code="label.swiftCode"/>:</b></td>
...
<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							...
							<td><a href="poPaymentHeadFullList" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
</div>