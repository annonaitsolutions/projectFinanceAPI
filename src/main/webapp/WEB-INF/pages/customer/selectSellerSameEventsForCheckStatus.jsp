<%@include file="taglib_includes.jsp" %>
   <div class="col-md-9 col-sm-9 col-lg-9 body_fixed">
	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
            <h3 align="center"><spring:message code="label.sellerSameBankDeailsStatus"/></h3> 
            <form:form action="" commandName="sellerSameBankEventForm">  
			   ...
			   <tr>
				...
				<tr>
				 ...
				 <tr>
					...
					<td> <form:input style="width: 60px;" size="3" path="" value="${model.tenure7}" readonly="true"/> 
		...
		<c:forEach items="${model.invoiceDocForms}" var="status">
			...
			<tr class="chargescolor">
				...
				<tr>
					...
					<table align="center">
						<tr>
							<td><a href="sellerSameViewAllEvents3" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
    </div>
