		...
		<div class="col-sm-12 col-md-6 col-lg-6">
			<div class="col-sm-12 col-md-12 col-lg-12">
				...
				<table width="400">
						...
						<tr>
							<td class="heading_text"><b><spring:message code="label.bankEmployeeAppStatus"/>:</b></td>
						...
						<tr>
							<td class="heading_text"><b><spring:message code="label.managerAppStatus"/>:</b></td>
				...
				<tbody>
					<c:if test="${! empty wclist}">
						<c:forEach items="${wclist}" var="wclist">
							<tr>
								<td><c:out value="${wclist.reason}"></c:out></td>
								<td><c:out value="${wclist.amount}"></c:out></td>
...
<div class="col-sm-12 col-md-12 col-lg-12">
					...
					<table align="center">
						<tr>
							<td><a href="masterPlanDetails" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
