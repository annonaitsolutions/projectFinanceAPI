...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
		 <h3><spring:message code="label.poInventoryManagement"/></h3>
	</div>
					...
					<c:if test="${! empty poList}">
						<c:forEach items="${poList}" var="master">
							<tr>
								...
								<td><c:out value="${master.availableQuantity}"></c:out></td>
<%--								<td><a href="inventoryShow?id=${master.id}"class="btn btn-primary"><spring:message code="label.select"/></a></td>--%>
							<td><a href="inventoryUpdateShow?id=${master.id}"class="btn btn-primary"><spring:message code="label.update"/></a></td>
							</tr>
						</c:forEach>
					</c:if>
