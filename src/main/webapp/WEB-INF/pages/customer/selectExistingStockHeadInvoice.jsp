...
<form:form action="updateExistingStockHeadInvoiceConfirm" method="post" name="interest" commandName="invoiceStockForm" onsubmit="return val();">
	 <div  class="successMsg"><b><font color="green">${success}</font></b></div>
		...
		<div class="col-sm-12 col-md-12 col-lg-12 newcustomer_border">
			<div class="content col-sm-12 col-md-12 col-lg-12">
								<table align="center">
								<caption><spring:message code="label.existingDetails"/></caption>
								<form:hidden path="id"/>
									<tr>
