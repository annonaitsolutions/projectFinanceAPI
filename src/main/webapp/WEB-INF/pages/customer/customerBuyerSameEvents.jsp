              ...
              <thead>
                ...
                <tr>
                    ...
                    <td><c:out value="${buyerSameBankEvents.supplierBank}"></c:out></td>
						 ...
						 <td><c:out value="${buyerSameBankEvents.uniqueId}"></c:out></td>
						 ...
						 <td><c:out value="${buyerSameBankEvents.customerStatus}"></c:out></td>
					
					<td><a href="selectCustomerSameBankEvents?id=${buyerSameBankEvents.id}" class="btn btn-primary"><spring:message code="label.select"/></a></td>
                </tr>
                </c:forEach>
                </c:if>
