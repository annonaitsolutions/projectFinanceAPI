<%@include file="taglib_includes.jsp" %>
 <div class="container">
    <div class="row">
        <div class="col-md-12">
            <h3 align="center">Seller Same Bank Details</h3> 
            <form:form action="selectCustomerSellerSameBankEvents" method="post" commandName="sellerSameBankEventForm">  
...
<form:hidden path="transactionId"></form:hidden>
		...
		<table class="table-bordered" align="center">
					...
					<tr>
						<td colspan="2">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">*</font>I Accept Terms and Conditions
										<form:input path="customerStatus" readonly="true"/>
						</td>
						<td></td>
					</tr> 
					...
					<tr>
						...
						<form:input path="customerComment" readonly="true"/>
						  </td>
