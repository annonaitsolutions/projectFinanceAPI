...
<form:form  action="masterPlanRePaymentAcceptSave" name="myForm" commandName="repaymentForm" onsubmit="return val();">
		...
		<div class="col-sm-12 col-md-12">	
					<div class="col-sm-12 col-md-12">
								<table align="center">
									...
									<tr>
										<td class="col-sm-5"><b><spring:message code="label.amtType"/>:</b></td>
