...
<div class="col-sm-9 col-md-9 body_fixed">
			<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
				<h3 align="center"><spring:message code="label.invoiceApprovedList"/></h3>
			</div>
			...
			<table class="table data jqtable example" id="my-table">
				<thead>
					<tr>
						...
						<th><spring:message code="label.availableQuantity"/></th>
					...
					<c:if test="${! empty invoiceList}">
						<c:forEach items="${invoiceList}" var="master">
							<tr>
								...
								<td><c:out value="${master.avail}"></c:out></td>
								<td><c:out value="${master.quantity}"></c:out></td>
								<td><a href="inventoryInvoiceShow?id=${master.id}"class="btn btn-primary"><spring:message code="label.select"/></a></td>
								<td><a href="invoiceInventoryUpdateShow?id=${master.id}"class="btn btn-primary"><spring:message code="label.update"/></a></td>
							</tr>
						</c:forEach>
					</c:if>
