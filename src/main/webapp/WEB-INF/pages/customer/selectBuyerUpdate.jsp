...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
		<h3 align="center"><spring:message code="label.buyerDetails"/></h3>
			...
			<form:form name="selectBuyerUpdate2" action="selectBuyerUpdate2" method="post" commandName="newBuyerForm" onsubmit="return val();">
				...
				<table  align="center">
					...
					<tr>
						...
						<td class="col-sm-6"><form:input path="name" id="name" readonly="true" /></td>
					</tr>
						<tr>
						<td class="col-sm-6"><b><spring:message code="label.country"/></b></td>
						<td class="col-sm-6"><form:input path="country" id="country" readonly="true"/></td>
						
					</tr>
					<tr>
						<td class="col-sm-6"><b><spring:message code="label.state"/></b></td>
						<td class="col-sm-6"><form:input path="state" id="state" readonly="true"/></td>
					...
					<tr>
						...
						<td class="col-sm-6"><form:input path="pinCode" id="pinCode"/>
							<div id="pinCodeError" style="display: none; color: red;"><spring:message code="label.validation" />
							</div>
					</tr>
				...
				<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							...
							<td><a href="newBuyerPage" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
