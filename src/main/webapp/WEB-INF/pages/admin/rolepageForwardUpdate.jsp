...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
  ...
  <div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
				...
				<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
					<h3 align="center"><spring:message code="label.approvalManager"/></h3>
				</div>
				<div class="col-sm-12 col-md-12 col-lg-12">
					<div  class="successMsg" style="text-align:center;color:green;font-size: 18px;">${success}</div>
   				</div>
					
			<form:form name="aprrovalManagerUpdate" action="aprrovalManagerUpdate" commandName="endUserForm" onsubmit="return validateForm()" >
			<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
					
					<tr>
					 <td class="col-sm-5"><b><spring:message code="label.id"/> :</b></td>
					 <td class="col-sm-7"><form:input path="id" id="id" value="${model.endUserForm.id}" readonly="true"/></td>
									...
									<tr>
										...
										<td class="col-sm-7">
										<form:input path="role" value="${model.endUserForm.role}" readonly="true"/>
										</td>
									</tr>
									...
									<tr>
										...
										<td class="col-sm-7">
										<form:input path="contactNo" value="${model.endUserForm.contactNo}" readonly="true"/>
										</td>
									</tr>
									...
									<tr>
										...
										<td class="col-sm-7">
										<form:input path="email" value="${model.endUserForm.email}" readonly="true"/>
