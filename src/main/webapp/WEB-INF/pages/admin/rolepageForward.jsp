...
function validateForm()
{
 ...
 <div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
			...
			<form:form name="role" action="roleApprovalList" commandName="endUserForm" onsubmit="return validateForm()" >
			<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.roleId"/></b></td>
				    ...
				    <tr>
						...
						<td class="col-sm-6"><form:input path="contactNo" id="contactNo" value="${model.endUserForm.contactNo}" readonly="true"/>
					
				    </tr>
					<tr>
						<td class="col-sm-6"><b><spring:message code="label.email"/></b></td>
						<td class="col-sm-6"><form:input path="email" value="${model.endUserForm.email}" readonly="true"/></td>
					</tr>
					
<%--					<tr>--%>
<%--						<td class="col-sm-6"><b><spring:message code="label.approvalManagerLimit"/></b></td>--%>
<%--						<td class="col-sm-6"><form:input path="approvallimit" value="${model.endUserForm.approvallimit}" readonly="true"/></td>--%>
<%--					</tr>--%>
...
<%--						</tr>--%>
					<tr>
						...
						<td class="col-sm-6">
						<form:input path="userName" value="${model.endUserForm.userName}" readonly="true"/>
