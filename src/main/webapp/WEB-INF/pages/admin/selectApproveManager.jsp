<%@include file="taglib_includes.jsp" %>
 <div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
			 		...
			 		<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
			 			 <h3 style="text-align:center;"><spring:message code="label.approvalManagerDetails"/></h3> 
			 		</div>
        <div class="col-md-12 col-md-12 col-lg-12">
            
            <form:form action="selectUpdateApproveManager" method="post" commandName="endUserForm">  
          	<table align="center">
          		<tr>
                  <td class="col-sm-6"><spring:message code="label.id"/></div>
			 ...
			 <div class="col-md-12 col-md-12 col-lg-12">&nbsp;</div>
			   <div class="col-md-12 col-md-12 col-lg-12">
           		 <table align="center">
					<tr>
						 <td><input type="submit" size="3" value="<spring:message code="label.sendEmailNotification"/>" class="btn btn-primary"></td>
						  <td><a href="#" class="btn btn-success"  onclick="javascript:window.location='appMngList';"><spring:message code="label.back"/></a></td>
