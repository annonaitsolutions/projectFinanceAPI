...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
 ...
 <div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
			 ...
			 <div class="col-sm-12 col-md-12 col-lg-12 header_customer">
				<div class="p_content">
					<form:form action="confirmEditAdminProfile" name="editProfile" autocomplete="off" commandName="endUserForm" onsubmit="return val();">
						...
						<form:hidden path="transactionId"/>
							<table align="center">
								...
								<tr>
									...
									<td class="col-sm-6"><form:input path="displayName" placeholder="Enter  Display Name" class="form-control" id="displayName"
							...
							<div id="contactNoError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>			
								...
								<tr>
									...
									<td class="col-sm-6"><form:input path="altContactNo" class="form-control"
										id="altContactNo" placeholder="Enter Alternate ContactNo" autocomplete="off"></form:input>
								...
								<tr>
									...
									<a href="editAdminPWD?id=${model.user.id}" style="color: #f89406;"><spring:message code="label.changePassword"/></a></td>
