...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
			 ...
			 <div class="col-sm-12 col-md-12 col-lg-12 header_customer">
			  ...
			  <div class="col-sm-12 col-md-12 col-lg-12 header_customer">
			 	<h3 align="center"><spring:message code="label.regNotBanned"/></h3>
			 </div>
			
				
				<form:form name="regulation" action="notBannedRegulationDetails"
					...
					<table align="center">
						...
						<tr>
							...
							<td class="col-sm-6"><form:input path="regulation"
									value="${model.regulationsForm.regulation}" readonly="true" />
							</td>
						</tr>
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.noExportableGoods"/>:</b></td>
							<td class="col-sm-6"><form:textarea path="bannedGoods"
									value="${model.regulationsForm.bannedGoods}" readonly="true" />
