...
<div class="col-sm-9 col-md-9 body_fixed">
		...
		<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
			<h3 align="center"><spring:message code="label.userTable"/></h3>
		</div>
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			...
			<table class="table data example jqtable" id="my-table">
				<thead>
					<tr>
								...
								<td><c:choose>
									...
									<c:otherwise>
								       ...
								       data-id="${user.id}" data-status="Blocked" 
										 class="open-rateDialog btn btn-primary" ><spring:message code="label.block"/></a>
										   </c:otherwise>
								</c:choose>
								</td>
									<td><c:choose>
									...
									<c:otherwise>
								       ...
								       data-id="${user.id}" data-status="Unblocked" 
										 class="open-rateDialog btn btn-primary" ><spring:message code="label.unblock"/></a>
										   </c:otherwise>
								</c:choose></td>
								<td><a href="getAdminRenew?id=${user.id}" class="btn btn-primary"><spring:message code="label.renew"/></a></td>
							</tr>
						</c:forEach>
					</c:if>
							...
							<div class="modal-body login-modal">
								...
								<div id='social-icons-conatainer'>
									<div class='modal-body-left'>
										<form:form id="form" action="blockUnblockAccount" commandName="endUserForm" >
