...
<script>
 ...
 <div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
		...
		<br>
		<form:form action="confirmBankDetails" method="post"
			...
			<tbody>
				<c:if test="${! empty bankDetails}">
					<c:forEach items="${bankDetails}" var="bankDetails">
						<tr>
							<td><c:out value="${bankDetails.id}"></c:out></td>
							<td><c:out value="${bankDetails.transactionId}"></c:out></td>
							<td><c:out value="${bankDetails.bankName}"></c:out></td>
							<td><c:out value="${bankDetails.location}"></c:out></td>
							<td><c:out value="${bankDetails.branch}"></c:out></td>
							<td><c:out value="${bankDetails.contactNo}"></c:out></td>
							<td><c:out value="${bankDetails.email}"></c:out></td>

							<td><a href="selectBankDetails?id=${bankDetails.id}"
