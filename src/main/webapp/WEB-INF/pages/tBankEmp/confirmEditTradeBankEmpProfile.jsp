...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
			<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
				...
				<form:form name="customerDetails" action="updateTradeBankEmpDetails" commandName="endUserForm"
						...
						<table align="center">
							<tr>
								<td class="col-sm-8"><input type="submit"  value="<spring:message code="label.update"/>" class="btn btn-primary"></td>		</td>
									<td><a href="tBankEmp" class="btn btn-success" ><spring:message code="label.back"/></a></td>
							</tr>
						</table>
					</div>
