...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
	<div class="col-sm-12 col-md-12 col-lg-12">
					<form:form action="confirmEditTradeBankEmpProfile" name="editProfile" autocomplete="off" commandName="endUserForm" onsubmit="return val();">
						...
						<form:hidden path="transactionId"/>
							<table align="center">
								...
								<tr>
									...
									<td class="col-sm-6"><form:input path="displayName" class="form-control" id="displayName" placeholder="Enter Display Name"

										 autocomplete="off"></form:input></td>
								</tr>
								<tr>
									<td class="col-sm-6"><label for=""><spring:message code="label.email"/>:</label></td>
									<td class="col-sm-6"><form:input path="email" class="form-control" placeholder="Enter Email"
						...
						<div id="EmailError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>		
							...
							<div id="altEmailError" style="display: none; color: red;"><spring:message code="label.altEmailNotCorrectFormat"/></div>
									</td>
								</tr>
								<tr>

									<td class="col-sm-6"><label for=""><spring:message code="label.contactNumber"/>:</label></td>
									<td class="col-sm-6"><form:input path="contactNo" class="form-control" id="contactNo" placeholder="Enter ContactNumber" autocomplete="off" ></form:input>
							<div id="contactNoError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>	
								...
								<tr>
									...
									<td class="col-sm-6"><label for=""><spring:message code="label.altcontactNumber"/>:</label></td>
									<td class="col-sm-6"><form:input path="altContactNo" class="form-control"

										id="altContactNo" placeholder="Enter Alternate ContactNumber" autocomplete="off"></form:input>
							...
							<div id="altContactNoError" class="error" style="display:none"><spring:message code="label.validation"/></div>
								...
								<tr>
									...
									<a href="editBankEmpTradePWD?id=${model.user.id}" style="color: #f89406;"><spring:message code="label.changePass"/></a></td>
									<td class="col-sm-6"><input type="submit"  value="<spring:message code="label.confirm"/>" class="btn btn-primary">
									<a href="tBankEmp" class="btn btn-success" ><spring:message code="label.back"/></a></td>
								</tr>
