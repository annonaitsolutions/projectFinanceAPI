					...
					<c:if test="${! empty repay}">
						<c:forEach items="${repay}" var="master">
							<tr>
								...
								<td><a href="tmasterPlanRePaymentBankFullList?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
									<td><a href="tmasterPlanRePaymentBankQuarterly?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
									<td><a href="tmasterPlanRePaymentBankHalfYearly?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
									<td><a href="tmasterPlanRePaymentMadeStatus?id=${master.id}"
