			...
			<div class="col-sm-12 col-md-12 col-lg-12">
				...
				<thead>
					<tr>
						...
						<th><spring:message code="label.sendApprove"/></th>
					</tr>
				</thead>
				<tbody>
					<c:if test="${! empty masterList}">
						<c:forEach items="${masterList}" var="master">
							<tr>
								...
								<td><a href="tbankMasterPlanFullDetails?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
									<td><a href="triskAssignment"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
									<td><a href="tmasterPlanCreditAssign?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.assign"/></a></td>
									<td><a href="tbankMasterPlanSend?id=${master.id}"
