...
<form:form action="tClientAdminConfirm" method="post" commandName="clientAdminForm" onsubmit="return val();">
	 <div  class="successMsg"><b><font color="green">${success}</font></b></div>
		...
		<div class="col-sm-12 col-md-12 col-lg-12 newcustomer_border">
			<div class="content col-sm-12 col-md-6 col-lg-6">
						...
						<td class="col-sm-6"><form:select path="companyId"
								readonly="true" id="companyId" style="width:205px;">
								<form:option value="">
					...
					<c:if test="${! empty adminList}">
						<c:forEach items="${adminList}" var="customer">
							<tr>
								...
								<td><a href="tSelectClientAdmin?id=${customer.id}"
