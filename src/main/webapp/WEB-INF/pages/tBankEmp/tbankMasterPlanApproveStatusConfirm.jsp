...
<%@taglib uri="http://www.springframework.org/tags" prefix="spring"%>
 ...
 <div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
	 ...
	 <form:form action="tbankMasterPlanApproveStatusPost" name="bankMasterPlanApproveStatusPost" method="post" commandName="tMasterPlanForm" onsubmit="return validateForm();">
			...
			<table align="center">
				<tr>
					...
					<td><a href="tbankMasterPlanPendingDetails" class="btn btn-success"><spring:message
