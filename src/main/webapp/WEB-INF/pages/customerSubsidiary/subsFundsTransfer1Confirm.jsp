...
<section>
<form:form action="subsFundsTransferPost" name="regulation" commandName="fundsDistributeForm" onsubmit="return validateForm()">
	 ...
	 <div  class="sucess"><b><font color="green">${success}</font></b></div>
								...
								<form:hidden path="balance"  />
									...
									<tr>
										...
										<td class="col-sm-8"><form:input path="amount" readonly="true"  placeholder="Enter Amount" id="amount" style="width:85%"></form:input>
