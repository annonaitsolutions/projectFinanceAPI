...
<div class="col-sm-9 col-md-9 body_fixed">	
	<div class="col-sm-12 col-md-12 header_customer">
		<div class="heading"><h3 align="center"><spring:message code="label.reports"/></h3></div>
	</div>

 
<form:form  action="reportsPOBranchPost" name="myForm" commandName="purchaseOrderForm" onsubmit="return val();">
						...
						<table align="center">
							...
							<tr>
								<td id="e1" class="col-sm-6">
								      	...
								      	<form:input id="datepicker" path="fromDate" class="datepicker form-control" placeholder="Select date" style="width: 206px;" readonly="true" /><i class="fa fa-calendar"></i>
								...
								<label><b><spring:message code="label.to"/></b></label>
			              				<form:input id="datepicker1" path="toDate" class="datepicker form-control" placeholder="Select date" style="width: 206px;" readonly="true" /><i class="fa fa-calendar"></i>
