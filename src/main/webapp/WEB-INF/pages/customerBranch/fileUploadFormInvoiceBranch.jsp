...
<div class="col-sm-9 col-sm-9 col-lg-9 body_fixed">
		...
		<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
			<h3 align="center"><spring:message code="label.uploadDocs"/></h3>
			
		</div>
<form:form method="post" enctype="multipart/form-data" name="fileUploadInovice" commandName="inoviceUploadForm" action="fileUploadInoviceBranch" onsubmit="return validateForm();">
			...
			<div class="col-sm-12 col-md-12 col-lg-12">	
				<table align="center">
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.customerName"/>
									</b></td>
					  ...
					  <form:hidden path="transactionId" value="" />
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.docsType"/>
									</b></td>
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.reasonUpload"/><spring:message code="label.reasonUpload"/>:</b><span style="color: red">*</span></td>
