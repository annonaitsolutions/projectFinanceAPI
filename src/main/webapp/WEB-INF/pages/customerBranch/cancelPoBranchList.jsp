					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header login_modal_header">
								...
								<h3 class="modal-title" id="myModalLabel">Rate this Supplier</h3>
							</div>
								...
								<div id='social-icons-conatainer'>
									<div class='modal-body-left'>
										...
										<div class="form-group">
											...
											Supplier Name :<form:input path="supplierName" id="supplierName" value="" class="form-control" readonly="true"/>											
										</div>
									...
									<div id="rateError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
										...
										<div class="form-group">
											...
											Comment :<form:textarea path="comment" id="comment" value="" class="form-control" />	
									<div id="commentError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>											
										...
										<a href="#" onClick="cancelPO(document.getElementById('id').value)" class="btn">Not Now</a>
										</form:form>
									</div>
								</div>																												
								<div class="clearfix"></div>
...
<script>
	...
	function cancelPO(id) {
		location.href = "cancelPoBranch?id="+id;
	}
</script>
