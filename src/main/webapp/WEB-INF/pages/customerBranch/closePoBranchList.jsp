							...
							<div class="modal-body login-modal">
								...
								<div id='social-icons-conatainer'>
									<div class='modal-body-left'>
										<form:form action="updateRateForSupplier" commandName="supplierForm" >
									...
									<div id="rateError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
										...
										<a href="#" onClick="closePO(document.getElementById('id').value)" class="btn"><spring:message code="label.notNow"/></a>
										</form:form>
									</div>
								</div>																												
								<div class="clearfix"></div>
...
function closePO(id) {		
	location.href = "closePoBranch?id="+id;
}
</script>