...
<form:form action="branchWareHouseMngSave" name="customerHeadSave" method="post" commandName="wareHouseMngForm" onsubmit="return validateForm();">
			...
			<div class="col-sm-6 col-md-6 col-lg-6">
					...
					<table align="center">
						<tr>
							...
							<td><a href="createBranchWareHouseMng" class="btn btn-success"><spring:message code="label.back"/></a></td>
