...
<form:form  action="poPaymentBranchLcPageConfirm" name="msplan" commandName="purchaseOrderForm" onsubmit="return val();">
						...
						<form:hidden path="id"  />
							...
							<table class="theader">
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="bankName" id="bankName" placeholder="Enter Bank name"></form:input></td>
					               ...
					               <td id="bankNameError" class="error" style="display:none"><spring:message code="label.validation"/></td>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="bankBranch" id="bankBranch" placeholder="Enter Bank Branch" ></form:input></td>
					               ...
					               <td id="bankBranchError" class="error" style="display:none"><spring:message code="label.validation"/></td>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="bankAddress"  id="bankAddress" placeholder="Enter Bank Address" ></form:input></td>
					               ...
					               <td id="bankAddressError" class="error" style="display:none"><spring:message code="label.validation"/></td>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="swiftCode"  placeholder="Enter Swift Code" id="swiftCode"></form:input></td>
					               ...
					               <td id="swiftCodeError" class="error" style="display:none"><spring:message code="label.validation"/></td>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="accNo"  placeholder="Enter Account Number" id="accNo"></form:input></td>
					               ...
					               <td id="contactNumError" class="error" style="display:none"><spring:message code="label.validation"/></td>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="contactPerson"  placeholder="Enter Contact Person" id="contactPerson"></form:input></td>
												 <td id="contactNumError" class="error" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></td>
