...
<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
	<form:form name="event" action="confirmSellerSameBankEvent" method="post" commandName="sellerSameBankEventForm" onsubmit="return validateForm();">
		<div class="center">
		...
		<table class="table-bordered theme">
			...
			<tbody>
				<tr>
					...
					<td id="e1"><form:input id="datepicker" path="date1" class="form-control" placeholder="Select date" style="width: 111px;" readonly="true"/><i class="fa fa-calendar"></i>
				...
				<tr>
					...
					<td><form:select style="width: 575px;" path="event3"><form:option value="${model.invoice.buyerName} opens a Letter of Credit favouring ${model.invoice.customerName}"/>
				...
				<tr>
					...
					<td><form:select style="width: 575px;" path="event4"><form:option value="${model.invoice.customerName} loads the ${model.invoice.goods} in a Truck and sends it to ${model.invoice.buyerName} (Single modal)"/>
				...
				<tr>
					...
					<td><form:hidden path="event7" value="Bank receives documents and forwards it to ${model.invoice.buyerName} for Acceptance of Documents"/>
					<p>Bank receives documents and forwards it to ${model.invoice.buyerName} for Acceptance of Documents</p></td>
				...
				<tr>
					...
					<td><form:hidden path="event8" value="${model.invoice.buyerName} accepts Bill of Exchange and takes the documents to release the ${model.invoice.goods}"/>
				...
				<tr>
					...
					<td><form:hidden path="event9" value="Bank Credits ${model.invoice.customerName} Account less the amount paid to ${model.invoice.buyerName}, Interest and other Charges"/>
					<p>Bank Credits ${model.invoice.customerName} Account less the amount paid to ${model.invoice.buyerName}, Interest and other Charges</p></td>
				...
				<tr>
					...
					<td><form:hidden path="event10" value="${model.invoice.buyerName} Receives ${model.invoice.goods}"/>
				...
				<tr>
					...
					<td><form:hidden path="event11" value="${model.invoice.buyerName} sells the ${model.invoice.goods} and pays the Bank"/>
					<p>${model.invoice.buyerName} sells the ${model.invoice.goods} and pays the Bank</p></td>
					<td><img src="<%=request.getContextPath()%>/resources/images/bankToCustomerMoney.png" class="imagesize" alt="img"></img></td>
				</tr> 
				<tr>
					<td>12</td>
					...
					<td><form:hidden path="event12" value="All Documents are Retired and Archived"/>
