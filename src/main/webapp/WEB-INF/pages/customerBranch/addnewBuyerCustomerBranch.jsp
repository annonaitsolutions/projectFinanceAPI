...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
	...
	<div class="col-sm-12 col-md-12 col-lg-12">
		<div class="successMsg"
			...
			<form:form action="updatenewBuyerBranchPage" method="post"
				...
				<div class="col-sm-6 col-md-6">
					...
					<form:input path="name" value="${model.newBuyerForm.name}" id="name" readonly="true"/>
						...
						<tr>
							...
							<td class="col-sm-6"><form:input path="buyerName" id="buyerName" placeholder="Enter Buyer Name"/>
								<div id="buyerNameError" style="display: none; color: red;"><spring:message code="label.validation"/></div>
								<div id="buyerNameError" style="display: none; color: red;"><spring:message code="label.validation"/></div></td>
						</tr>
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.companyName"/></b><span
								style="color: red">*</span></td>
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.buyerBankEmail"/></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><form:input path="bankEmail" id="bankEmail" placeholder="Enter Buyer Bank Email"/>
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.buyerBankBranch" /></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><form:input path="branch" id="branch" placeholder="Enter Buyer Bank Branch"/>
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.ifscOrSwift" /></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><form:input path="ifsc" id="ifsc" placeholder="Enter Buyer Bank Branch"/>
				...
				<table align="center">					
						...
						<tr>
							...
							<td class="col-sm-6"><form:select path="country" id="country" value=""  style="width:205px;"/>
								<div id="countryError" style="display: none; color: red;"><spring:message code="label.plzSelectValue"/></div>
								<div id="countryError" style="display: none; color: red;"><spring:message code="label.plzSelectValue"/></div></td>
						</tr>
						<tr>
							...
							<td class="col-sm-6"><form:select path="state" id="state" value="" style="width:205px;"/> <script
								...
								<div id="stateError" style="display: none; color: red;"><spring:message code="label.plzSelectValue"/></div>
								<div id="stateError" style="display: none; color: red;"><spring:message code="label.plzSelectValue"/></div></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.altContactNo"/></b>
					...
					<form:hidden path="rate" id="rate" value="0"/>
						...
						<td class="col-sm-6"><div class="basic"	data-average="5" data-id="1"></div>
		...
		<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
			<h3><spring:message code="label.buyerList"/></h3>
		</div>
				<div class="col-sm-12 col-md-12 col-lg-12">
					...
					<c:if test="${! empty newbuyeList}">
						<c:forEach items="${newbuyeList}" var="buyer">
							<tr>
                                ...
                                <td><a href="selectBuyerForCustomerBranchUpdate?id=${buyer.id}"class="btn btn-primary"><spring:message code="label.edit"/></a></td>
							</tr>
						</c:forEach>
					</c:if>
