...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
		<div class="col-sm-12 col-md-12 col-lg-12">	
			...
			<form:form action="branchBusinessPlanForInvoiceConfirm" method="post" name="interest"
				...
				<div class="col-sm-12 col-md-12 col-lg-12 header_customer">	
					...
					<table align="center">
						...
						<tr>
							...
							<td class="col-sm-6"><form:input path="poKey" id="poKey" placeholder="Enter Po Key"/>
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.poDate"/></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><form:input id="datepicker" path="poDate" placeholder="Enter Po Date"/>
						...
						<tr>
							...
							<td class="col-sm-6"><form:input path="poInfo" id="poInfo" placeholder="Enter Po Info"/>
								<div id="poInfoError" style="display: none; color: red;"><spring:message code="label.validation"/></div>
								<div id="poInfoError" style="display: none; color: red;"><spring:message code="label.validation"/></div></td>
						</tr>
						</table>
				</div>
				...
				<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
					...
					<table align="center">
						...
						<tr>
							...
							<td class="col-sm-6"><form:input path="goodsDetails" id="goodsDetails" placeholder="Enter Goods Details"/>
						...
						<form:option value=""><spring:message code="label.selectValue"/></form:option>
							...
							<div id="wareHouseNameError" style="display: none; color: red;"><spring:message code="label.plzSelectValue"/></div>
								<div id="wareHouseNameError" style="display: none; color: red;"><spring:message code="label.plzSelectValue"/></div></td>
