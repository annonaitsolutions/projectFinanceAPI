...
<form:form action="inventoryPoListForBranchShowConfirm" name="interest" commandName="inventoryForm" onsubmit="return Val();">
		...
		<div class="col-sm-12 col-md-12">
			<table align="center">
				...
				<tr>	
					...
					<td class="col-sm-6"><form:input path="usedQuantity" id="usedQuantity" placeholder="Enter usedQuantity"/></td>
				...
				<tr>
					<td class="col-sm-6"><spring:message code="label.returnedQty"/></td>
					<td class="col-sm-6"><form:input path="returned" id="returned" placeholder="Enter returnedQty"/></td>
				...
				<tr>	 
					...
					<td class="col-sm-6"><form:input path="damaged" id="damaged" placeholder="Enter damagedQuantity"/></td>
				...
				<tr>
					 <td colspan="2"><input type="button" value="CALCULATE" class="btn btn-primary" size="5" onClick="Val1()">
