			...
			<table class="table data jqtable example" id="my-table">
				<thead>
					<tr>
						...
						<th><spring:message code="label.invDate"/></th>
					...
					<c:if test="${! empty invoiceList}">
						<c:forEach items="${invoiceList}" var="master">
							<tr>
								...
								<td><a href="inventoryInvoiceBranchShow?id=${master.id}"class="btn btn-primary"><spring:message code="label.select"/></a></td>
								<td><a href="invoiceInventoryBranchUpdateShow?id=${master.id}"class="btn btn-primary"><spring:message code="label.update"/></a></td>
							</tr>
						</c:forEach>
					</c:if>
