...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
	<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<tr>
			...
			<td class="col-sm-6"><input type="text"  placeholder="Enter Mark Up" name="rate" size="7"></td>
		</tr>
		
		<tr>
			<td class="col-sm-6"><spring:message code="label.amtToCalc"/></td>
			<td class="col-sm-6"><input type="text"  placeholder="Enter Amount To be Converted" name="value" size="7"></td>
		</tr>
