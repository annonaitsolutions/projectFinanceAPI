...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
        ...
        <form method="post" action="branchMailSender" name="myForm" onsubmit="return validateForm();">
            <table align="center">
                 <tr>
                    <td class="col-sm-6"><spring:message code="label.to"/>:</td>
                    <td class="col-sm-6"><input type="text" name="recipient" placeholder="Enter a Email" id="recipient" size="65" /></td>
                </tr>  
                <tr>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							<td class="col-sm-8"><input type="submit" value="<spring:message code="label.sendEmailNotification"/>" class="btn btn-primary"></td>
													</tr>
					</table>
		        </div>
        </form>
