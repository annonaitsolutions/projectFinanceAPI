...
<div class="col-sm-6 col-md-9 col-lg-9 body_fixed">
				...
				<form:form action="addOrModifyReportBranchConfirm" method="post" commandName="disputeReportsForm" enctype="multipart/form-data"  name="interest" onsubmit="return val();">
