...
<div class="col-sm-9 col-sm-9 col-lg-9 body_fixed">
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			<form:form action="supplierPageForwardCustomerBranch" method="post" commandName="supplierForm" id="newSupplier" onsubmit="return val();">
					...
					<form:input path="name" value="${model.supplierForm.name}" id="name" readonly="true"/>
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.supplierCompanyName"/></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><form:input path="companyName" id="companyName" placeholder="Enter Company Name"/>
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.supplierBank"/></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><%-- <form:input path="bank" id="bank" placeholder="Enter Bank Name"/> --%>
								...
								<form:select path="bank"  id="bank">
										...
										<form:option value="BANK OF BAHRAIN AND KUWAIT">	Bank of Bahrain and Kuwait</form:option>
                                   		...
                                   		<form:option value="HDFC Bank Pvt Ltd">	HDFC Bank Pvt Ltd </form:option>					
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.supplierBankEmail"/></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><form:input path="bankEmail" id="bankEmail" placeholder="Enter Bank Email"/>
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.bankBranch"/></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><form:input path="branch" id="branch" placeholder="Enter Bank Branch"/>
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.ifscOrSwift"/></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><form:input path="ifsc" id="ifsc" placeholder="Enter Bank Branch"/>
								<div id="ifscError" style="display: none; color: red;"><spring:message code="label.validation"/></div>
								<div id="ifscError" style="display: none; color: red;"><spring:message code="label.validation"/></div></td>
						</tr>
						<tr>
						...
						<tr>
										<td class="col-sm-6"><b><spring:message code="label.accountExpiry"/></b><span style="color:red">*</span></td>										
										<td class="col-sm-6"><form:input path="accExpiryDate" class="form-control" placeholder="Select date" style="width: 206px;" readonly="true" id="datepicker"/><i class="fa fa-calendar"></i>
				...
				<table>
						...
						<tr>
							<td class="col-sm-6"><b><spring:message code="label.country"/></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><form:select path="country" id="country" value="" style="width: 206px;"/>
								<div id="countryError" style="display: none; color: red;"><spring:message code="label.pleaseSelectAValue"/></div>
								<div id="countryError" style="display: none; color: red;"><spring:message code="label.pleaseSelectAValue"/></div></td>
						</tr>

						<tr>
							<td class="col-sm-6"><b><spring:message code="label.state"/></b><span
								style="color: red">*</span></td>
							<td class="col-sm-6"><form:select path="state" id="state" value="" style="width: 206px;"/>
							 <script>
								populateCountries("country", "state");
							</script>
								<div id="stateError" style="display: none; color: red;"><spring:message code="label.pleaseSelectAValue"/></div>
								<div id="stateError" style="display: none; color: red;"><spring:message code="label.pleaseSelectAValue"/></div></td>
						</tr>
						<tr>
	...
	<tr>
							<td class="col-sm-6"><b><spring:message code="label.currencyDealt"/></b><span style="color: red">*</span></td>
								<td class="col-sm-6">
							<form:select path="currencydeal"  id="currencydeal" style="width: 206px;">
						...
						<div id="currencydealError" class="error" style="display:none;color:red;"><spring:message code="label.pleaseSelectAValue"/></div>
						<div id="currencydealError" class="error" style="display:none;color:red;"><spring:message code="label.pleaseSelectAValue"/></div>
					   		</td>
						</tr>
						...
						<tr>
							...
							<td class="col-sm-6"><form:input path="altEmail" id="altEmail" placeholder="Enter Alternate Email"/></td>
						...
						<tr>
							...
							<td class="col-sm-6"><form:input path="altContactNum" id="altContactNum" placeholder="Enter Alternate Contact Number"/></td>
					...
					<tr>
						...
						<td class="col-sm-6"><div class="basic" data-average="5"></div>
							<div id="rateError" style="display: none; color: red;"><spring:message code="label.validation"/></div></td>
					</tr>
						...
						<c:if test="${! empty supplierList}">
							<c:forEach items="${supplierList}" var="supplier">
								<tr>
                                    ...
                                    <td><a href="selectsupplierUpdateForCustomerBranch?id=${supplier.id}"
