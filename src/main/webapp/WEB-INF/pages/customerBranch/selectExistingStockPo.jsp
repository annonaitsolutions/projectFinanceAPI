...
<form:form action="updateExistingStockPoConfirm" method="post" name="interest" commandName="poStockForm" onsubmit="return val();">
		...
		<div class="col-sm-12 col-md-12 col-lg-12 ">
								...
								<tr>
									...
									<tr>
											...
											<td class="col-sm-6"><form:input path="quantity" placeholder="Enter pincode" id="quantity"></form:input>
									...
									<tr>
											...
											<td class="col-sm-6"><form:input path="usedQuantity" placeholder="Enter pincode" id="usedQuantity"></form:input>
									...
									<tr>
											...
											<td class="col-sm-6"><form:input path="damaged" placeholder="Enter pincode" id="damaged"></form:input>
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
					<table align="center">
						<tr>
							...
							<td><a href="existingStockPo" class="btn btn-success"><spring:message code="label.back"/></a></td>
						</tr>
					</table>
		        </div>
