...
<form:form  action="poPaymentBranchLcPageSave" name="msplan" commandName="letterOfCreditForm" onsubmit="return val();">
					...
					<div class="col-sm-12 col-md-6 col-lg-6">
						...
						<form:hidden path="id"  />
								...
								<div class="col-sm-12 col-md-6 col-lg-6">	
									...
									<tr>
										<td class="col-sm-5"><b><spring:message code="label.ifscOrSwift"/>:</b></td>
										<td class="col-sm-7"><form:input path="ifscOrSwift" readonly="true"  placeholder="Enter contact number" id="customerPrefix"></form:input>
											
									</tr>
								
									<tr>
										<td class="col-sm-5"><b><spring:message code="label.accountNumber"/>:</b></td>
									...
									<tr>
										<td class="col-sm-5"><b><spring:message code="label.contactPerson"/>:</b></td>
										<td class="col-sm-7"><form:input path="contactPerson" readonly="true"  placeholder="Enter contact number" id="customerPrefix"></form:input>
