			...
			<table class="table data jqtable example" id="my-table">
				<thead>
					<tr>
						...
						<th><spring:message code="label.requestForMoney"/></th>
						...
						<c:forEach items="${masterList}" var="master">
							<tr>
								...
								<td><c:out value="${master.busBalance}"></c:out></td>
									<td><a href="branchFundsTransfer1?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.transfer"/></a></td>
