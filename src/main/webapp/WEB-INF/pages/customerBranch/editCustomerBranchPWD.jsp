...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
				<div class="p_content">
					<form:form action="updateEditCustomerBranchPWD" name="editProfile" autocomplete="off" onsubmit="return validateForm()" commandName="endUserForm">
						
						<div class="form_page">
						<form:hidden path="id"/>
						<form:hidden path="transactionId"/>
						<div id="alertPWD" style="display: none; color: red;text-align:center;"><spring:message code="label.passVal"/></div>
				<div id="alertPWD" style="display: none; color: red;text-align:center;"><spring:message code="label.passVal"/></div>
						
							<table align="center" style="margin-top: 56px;">
