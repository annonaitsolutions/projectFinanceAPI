...
<form:form action="branchWareHouseMngConfirm" method="post" commandName="wareHouseMngForm" onsubmit="return val();">
	 <div  class="successMsg"><b><font color="green">${success}</font></b></div>
				<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
					<h3 align="center"><spring:message code="label.addwhmng"/></h3>
				</div>
		<div class="col-sm-12 col-md-12 col-lg-12 newcustomer_border">
			<div class="content col-sm-12 col-md-6 col-lg-6">
								...
								<caption><spring:message code="label.addPersonalDetails"/></caption>
									<tr>
										...
										<td class="col-sm-6"><form:input path="mngName" id="name" placeholder="Enter Name"></form:input>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="contactNum" placeholder="Enter Contact Number" id="contactno"></form:input>
											<span id="contactnoError" class="error" style="display:none;"><font color="red"><spring:message code="label.validation"/>*</font></span>
										  	<span id="contactnoError" class="error" style="display:none"><spring:message code="label.validation"/></span></td>
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="email" placeholder="Enter Email id" id="email"></form:input>
											<span id="emailError1" class="error" style="display:none;"><font color="red"><spring:message code="label.validation"/>*</font></span>
										   <span id="emailError1" class="error" style="display:none"><spring:message code="label.validation"/></span></td>
									...
									<tr>
										...
										<td id="e1" class="col-sm-6"><form:input path="accExpiryDate" class="form-control" placeholder="Select Date" style="width: 206px;" readonly="true" id="datepicker"/>
			...
			<div class="customer_headers"><h3></h3></div>
			<div class="content">
							...
							<caption><spring:message code="label.companyDetails"/></caption>
									<tr class="rowcolor">
										...
										<td class="col-sm-6"><form:input path="companyName" placeholder="Enter Company Name" id="companyName"></form:input>
									 	<span id="companyNameError" class="error" style="display:none;"><font color="red"><spring:message code="label.validation"/>*</font></span>
										<span id="companyNameError" class="error" style="display:none"><spring:message code="label.validation"/></span></td>
									</tr>
									<tr>
										<td class="col-sm-6"><b><spring:message code="label.companyPrefix"/></b><span style="color:red">*</span></td>
										<td class="col-sm-6"><form:input path="companyPrefix" placeholder="Enter Company Prefix" id="companyPrefix"></form:input>
										<span id="companyPrefixError" class="error" style="display:none;"><font color="red"><spring:message code="label.validation"/>*</font></span>
										<span id="companyPrefixError" class="error" style="display:none"><spring:message code="label.validation"/></span></td>
									...
									<tr>
											...
											<div id="countryError" style="display: none; color: red;"><spring:message code="label.validation2"/></div>
								<div id="countryError" style="display: none; color: red;"><spring:message code="label.validation2"/></div></td>
											
									</tr>
									<tr>
											<td class="col-sm-6"><b><spring:message code="label.state"/></b><span style="color:red">*</span></td>
											<td class="col-sm-6"><form:select path="state" placeholder="Select State" id ="state" style="width:205px;"></form:select>
											<script>
								  ...
								  <div id="stateError" style="display: none; color: red;">State
									...
									<tr>
										...
										<td class="col-sm-6"><form:input path="city" placeholder="Enter City" id="city"></form:input>
										<span id="cityError" class="error" style="display:none;"><font color="red"><spring:message code="label.validation"/>*</font></span>
										<span id="cityError" class="error" style="display:none"><spring:message code="label.validation"/></span></td>
									</tr>
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<a href="userBranch" class="btn btn-success"><spring:message code="label.back"/></a>
								</p>
		</div>
		</div>
		</form:form>
		...
		<span class="counter pull-right"></span>
			...
			<table class="table data jqtable example" id="my-table">
				<caption><spring:message code="label.warreHouseMngDetails"/></caption>
				<thead>
					<tr>
				...
				<tbody>
					<c:if test="${! empty mngList}">
						<c:forEach items="${mngList}" var="customer">
							<tr>
								...
								<td><a href="selectBranchWareHouseMng?id=${customer.id}"
