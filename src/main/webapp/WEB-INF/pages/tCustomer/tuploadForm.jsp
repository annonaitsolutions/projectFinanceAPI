...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">	
	...
	<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<form:form method="post" enctype="multipart/form-data" name="TfileUpload" commandName="tuploadedFileForm" action="fileUpload1" onsubmit="return validateForm();">
					...
					<table align="center">
								...
								<tr>
									...
									<td class="col-sm-6"><form:input path="document" placeholder="Enter Type Of Document" id="Document"/>
...
<script>
	function validateForm() {
		...
		document.TfileUpload.transactionId.value = uuid;
	}
</script>