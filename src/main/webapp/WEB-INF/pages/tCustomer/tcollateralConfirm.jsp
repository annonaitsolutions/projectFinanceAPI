...
<div class="col-sm-9 col-sm-9 col-lg-9 body_fixed">
		...
		<div class="col-sm-12 col-md-12 col-lg-12">	
				...
				<form:form action="tcollateralPost" commandName="tcollateralForm">
				...
				<div class="col-sm-5"><b><spring:message code="label.propertyType"/>:</b><span style="color:red"></span></div>
				<div class="col-sm-7">
					<form:input path="propertyType" readonly="true" id="propertyType"/>
				</div>
				<div class="col-sm-5"><b><spring:message code="label.address"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="propertyAddress" readonly="true"  class="form-control" placeholder="Enter the Address"  id="propertyAddress"/>
						</div>	
						
						<div class="col-sm-5"><b><spring:message code="label.area"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="propertyArea"  readonly="true" class="form-control" placeholder="Enter the Area"  id="propertyArea"/>
						</div>	
						
						<div class="col-sm-5"><b><spring:message code="label.costPerArea"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="pCostPerArea" readonly="true" class="form-control" placeholder="Enter the Cost Per Area"  id="pCostPerArea"/>
						</div>
					<div class="col-sm-5"><b><spring:message code="label.purchaseValue"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
						...
						<div class="col-sm-5"><b><spring:message code="label.currentMarketValue"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
						...
						<div class="col-sm-5"><b><spring:message code="label.existingCharge"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
								<form:input path="pExisCharge" id="pExisCharge"  readonly="true"  />
						</div>
				</div>
				<div class="col-sm-6 col-md-6 col-lg-6">
				<div class="col-sm-12 col-md-12 col-lg-12">			
				...
				<div class="col-sm-5"><b><spring:message code="label.vehicleType"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
								<form:input path="vType" id="vType"  readonly="true" />
						</div>	
						<div class="col-sm-5"><b><spring:message code="label.purchaseValue"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="vPurchaseValue" readonly="true"  class="form-control" placeholder="Enter Purchase Value"  id="vPurchaseValue"/>
						</div>	
						<div class="col-sm-5"><b><spring:message code="label.currentMarketCost"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="VcurrValue" readonly="true"   class="form-control" placeholder="Enter the Current Market Value"  id="VcurrValue"/>
						</div>	
						<div class="col-sm-5"><b><spring:message code="label.details"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="vDeatils"  readonly="true"  class="form-control" placeholder="Enter the Details"  id="vDeatils"/>
						</div>	
						<div class="col-sm-5"><b><spring:message code="label.insurance"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="vInsurence" id="vInsurence"  readonly="true" />
											
						</div>
						<div class="col-sm-5"><b><spring:message code="label.startDate"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
						...
						<div class="col-sm-5"><b><spring:message code="label.endDate"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							...
							<div class="col-sm-5"><b><spring:message code="label.existingCharge"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="vExistingCharge" id="vExistingCharge"  readonly="true"  />
					...
					<div class="col-sm-6 col-md-6 col-lg-6">
						...
						<div class="col-sm-5"><b><spring:message code="label.amount"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="amount" readonly="true"  class="form-control" placeholder="Enter Amount"  id="amount"/>
						</div>	
							<div class="col-sm-5"><b><spring:message code="label.financialInstitution"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="FinInstitution" id="FinInstitution"  readonly="true" />
						</div>
						<div class="col-sm-5"><b><spring:message code="label.branch"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="branch" readonly="true"  class="form-control" placeholder="Enter Branch"  id="branch"/>
						</div>	
						<div class="col-sm-5"><b><spring:message code="label.location"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="location" readonly="true"   class="form-control" placeholder="Enter Location"  id="location"/>
						</div>	
						<div class="col-sm-5"><b><spring:message code="label.fdStartDate"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="fDStartDate" readonly="true"  class="form-control" placeholder="Enter FD Start Date"  id="fDStartDate"/>
						</div>
						<div class="col-sm-5"><b><spring:message code="label.fdEndDate"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="fDEndDate" readonly="true"  class="form-control" placeholder="Enter FD End Date"  id="fDEndDate"/>
						</div>
						<div class="col-sm-5"><b><spring:message code="label.fdInterestRate"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							...
							<div class="col-sm-5"><b><spring:message code="label.existingCharge"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="cExistimgCharge" readonly="true"  id="cExistimgCharge"/>
				...
				<div class="col-sm-6 col-md-6 col-lg-6">
						...
						<div class="col-sm-5"><b><spring:message code="label.beneficiaryName"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="benficiaryName" readonly="true"  class="form-control" placeholder="Enter Name" id="benficiaryName"/>
						</div>	
						
						<div class="col-sm-5"><b><spring:message code="label.nominee"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="nominee" readonly="true"  class="form-control" placeholder="Enter Nomimee"  id="nominee"/>
						</div>	
						
						 <div class="col-sm-5"><b><spring:message code="label.policyStartDate"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="policyStartDate" readonly="true"  class="form-control" placeholder="Enter start Date"  id="policyStartDate"/>
						</div>	
						
						<div class="col-sm-5"><b><spring:message code="label.policyEndDate"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="policyEndDate" readonly="true"  class="form-control" placeholder="Enter end Date"  id="policyEndDate"/>
						</div>
						
						
						<div class="col-sm-5"><b><spring:message code="label.premiumPayment"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="premiumPayment" id="premiumPayment" readonly="true" />
						</div>
						<div class="col-sm-5"><b><spring:message code="label.valueOfPolicy"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							...
							<div class="col-sm-5"><b><spring:message code="label.existingCharge"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="policyExisCharge" id="policyExisCharge" readonly="true" />
						</div>
					</div>
					...
					<div class="col-sm-6 col-md-6 col-lg-6">
						...
						<div class="col-sm-5"><b><spring:message code="label.shares"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="companyShares" readonly="true"  class="form-control" placeholder="Enter Shares" id="companyShares"/>
						</div>
						
						<div class="col-sm-5"><b><spring:message code="label.sharesExistingPrice"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="sharesExisPrice" readonly="true"  class="form-control" placeholder="Enter Existing Price" id="sharesExisPrice"/>
						</div>
						
						<div class="col-sm-5"><b><spring:message code="label.companyDetails"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="details" readonly="true"  class="form-control" placeholder="Enter Details"  id="details"/>
						</div>
						
						<div class="col-sm-5"><b><spring:message code="label.turnOver"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="turnOver" readonly="true"  class="form-control" placeholder="Enter Turn Over" id="turnOver"/>
						</div>
						
						<div class="col-sm-5"><b><spring:message code="label.profit"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="profit" readonly="true"  class="form-control" placeholder="Enter Profit" id="profit"/>
						</div>
						
						<div class="col-sm-5"><b><spring:message code="label.lineOfActivities"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							...
							<div class="col-sm-5"><b><spring:message code="label.existingCharge"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="sharesExisCharge" id="sharesExisCharge" readonly="true" />
				...
				<div class="col-sm-6 col-md-6 col-lg-6">
						...
						<div class="col-sm-5"><b><spring:message code="label.registrationNumber"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
						...
						<div class="col-sm-5"><b><spring:message code="label.existingCharge"/>:</b><span style="color:red"></span></div>
						<div class="col-sm-7">
							<form:input path="machineryExisCharge" readonly="true"  id="machineryExisCharge"/>
