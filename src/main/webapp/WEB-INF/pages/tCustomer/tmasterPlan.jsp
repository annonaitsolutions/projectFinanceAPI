...
<form:form action="tmasterPlanCurrency" commandName="tMasterPlanForm" onsubmit="return val();">
...
<h3 align="center"><spring:message code="label.masterPlan"/></h3>
 ...
 <div  class="successFull" style="text-align:center;color:green;font-size: 18px;">${successFull}</div>
								...
								<center>
								<div id="currencyError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
								<div id="currencyError" class="error" style="display:none"><spring:message code="label.validation"/></div>
								</center>			
