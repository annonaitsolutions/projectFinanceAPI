	...
	<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
		...
		<table  align="center">
			...
			<tr>
				...
				<td class="col-sm-6"><input type="text" name="rupee" placeholder="Enter Rupee"  onChange="rupeeConverter()" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><input type="button" class="btn btn-primary" value="<spring:message code="label.curConvert"/>" /></td>
			</tr>
		</table>
		</form>
	</div>
