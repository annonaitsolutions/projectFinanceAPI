					...
					<c:if test="${! empty repayList}">
						<c:forEach items="${repayList}" var="master">
							<tr>
								...
								<td><a href="tmasterPlanRePaymentCustFullList?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
									<td><a href="tmasterPlanRePaymentCustQuarterly?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
									<td><a href="tmasterPlanRePaymentCustHalfYearly?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.view"/></a></td>
								<td><a href="tmasterPlanRePaymentAccept?id=${master.id}"
									class="btn btn-primary"><spring:message code="label.acc/rej"/></a></td>
