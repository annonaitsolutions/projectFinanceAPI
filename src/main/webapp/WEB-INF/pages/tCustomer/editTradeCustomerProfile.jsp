...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
		<div class="col-sm-12 col-md-12 col-lg-12">
				<div class="p_content">
					<form:form action="confirmEditTradeCustomerProfile" name="editProfile" autocomplete="off" commandName="endUserForm" onsubmit="return val();">
						...
						<form:hidden path="transactionId"/>
							<table align="center">
								...
								<tr>
									...
									<td class="col-sm-6"><form:input path="displayName" class="form-control" id="displayName" placeholder="Enter DispalyName"
										 autocomplete="off"></form:input></td>
								</tr>
								<tr>
									<td class="col-sm-6"><label for=""><spring:message code="label.email"/> :</label></td>
									<td class="col-sm-6"><form:input path="email" class="form-control" placeholder="Enter Eamil"
							...
							<div id="EmailError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>	
								...
								<tr>
									...
									<td class="col-sm-6"><form:input path="altEmail" class="form-control"
										id="altEmail" placeholder="Enter AlternateEmail" autocomplete="off"></form:input>
							<div id="altEmailError" style="display: none; color: red;"><spring:message code="label.altEmailNotCorrectFormat"/></div>
								...
								<tr>
									...
									<td class="col-sm-6"><form:input path="contactNo" class="form-control"
										id="contactNo" placeholder="Enter ContactNumber" autocomplete="off" ></form:input>
					...
					<div id="altContactNoError" class="error col-sm-12" style="display:none;"><font color="red"><spring:message code="label.validation"/></font></div>
								...
								<tr>
									<td class="col-sm-6">
									<a href="editCustomerTradePWD?id=${model.user.id}" style="color:tomato;"><spring:message code="label.changePassword"/></a></td>
									<td class="col-sm-6"><input type="submit"  value="<spring:message code="label.confirm"/>" class="btn btn-primary">
									<a href="tUser" class="btn btn-success" ><spring:message code="label.back"/></a></td>
								</tr>
