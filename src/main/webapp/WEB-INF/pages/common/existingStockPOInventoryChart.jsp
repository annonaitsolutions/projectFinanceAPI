...
<div class="col-sm-12 col-md-12 col-lg-12 header_customer">
	...
	<form:form action="existingStockPOInventoryChartById" commandName="wareHouseForm">
		...
		<div onload="prettyPrint();">
			...
			<ul>							
				<c:forEach var="warehouse" items="${model.warehouseChart}">
					...
					<table width="400" class="table table-bordered" style="margin-top: 0px;width: 321px;margin-left: -90px;">
					<tr>
					...
					<img src="<%=request.getContextPath()%>/resources/images/warehouse.png">
								...
								<li>
								<table align="center" width="400" style="margin-left:-120px;">
										<tr>
									...
									<ul>
										<li><%-- <spring:message code="label.overall"/> --%><img style="margin-top: -65px;" src="<%=request.getContextPath()%>/resources/images/overall.png"><br>${goods.quantity}
											<ul>
