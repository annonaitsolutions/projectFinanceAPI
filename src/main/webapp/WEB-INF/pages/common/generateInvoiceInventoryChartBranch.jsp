...
<div class="col-sm-9 col-md-9 col-lg-9 body_fixed">
	...
	<form:form action="generateInvoiceInventoryChartBranchById" commandName="wareHouseForm">
	...
	<div class="col-sm-3 col-md-3 col-lg-3">
		...
		<video id="video1" width="400" height="300" controls>
			<source src="<%=request.getContextPath()%>/resources/videos/selling.mp4" type="video/mp4">
		</video>
	</div>
	<div class="col-sm-12 col-md-12 col-lg-12">
		<div onload="prettyPrint();">
			...
			<ul>							
				<c:forEach var="warehouse" items="${model.warehouseChart}">
					...
					<table width="400" class="table table-bordered" style="margin-top: 0px;width: 321px;margin-left: -93px;">
					<tr>
					...
					<img src="<%=request.getContextPath()%>/resources/images/warehouse.png">
								...
								<table width="400" class="table table-bordered" style="margin-top: 0px;width: 321px;margin-left: -93px;">
										...
										<tr>
											...
											<td>${goods.amount}</td>
											<td>${goods.buyerName}</td>
										</tr>
									</table>
									<ul>
										<li><%-- <spring:message code="label.overall"/> --%><img src="<%=request.getContextPath()%>/resources/images/overall.png"><br>${goods.quantity}
											<ul>
												...
												<li><spring:message code="label.available"/><img src="<%=request.getContextPath()%>/resources/images/returned.png"><br>${goods.avail}</li>
											</ul>
										</li>
									</ul>
								</li>
